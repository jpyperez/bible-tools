var book = {
	...
	"chapters": {
		...
		"2": {
			...
			"7": "<sup>7</sup> Vrata rek so odprta in palača se maje;",
			"8": "<sup>8</sup> še stoječo vlačijo stran, odnašajo, njene dekle stokajo, kakor je glas golobov, se bijejo po prsih.",
			"9": "<sup>9</sup> Ninive so kakor ribnik vode, njegove vode in oni sami bežijo: »Stojte, stojte!« a se nihče ne obrne.",
			"10": "<sup>10</sup> Ropajte srebro, ropajte zlato! Ni konca zakladov, bogastva vsakovrstnih dragocenih reči.",
		...
		"3": {
			...
			"9": "<sup>9</sup> Njena moč je bil Kuš in Egipt, ki je bil neizčrpen, Put in Libijci so ji bili v pomoč.",
			"10": "<sup>10</sup> Tudi ona je morala v izgnanstvo, šla je v ujetništvo; tudi njeni otročiči so bili raztreščeni po vogalih vseh ulic, za njene odličnike so metali žreb, vsi njeni velikaši so bili vkovani v verige.",
			"11": "<sup>11</sup> Tudi ti se boš opila, mrakotna boš postala, tudi ti boš iskala zavetje pred sovražnikom.",
			"12": "<sup>12</sup> Vse tvoje trdnjave so smokve z zgodnjimi sadeži: ko jih kdo potrese, padejo v usta temu, ki jih hoče jesti.",
			"13": "<sup>13</sup> Glej, tvoja vojska so ženske v tvoji sredi. Tvojim sovražnikom so na stežaj odprta vrata tvoje dežele; ogenj je požrl tvoje zapahe.",
			"14": "<sup>14</sup> Pripravi si vode za čas, ko boš oblegana, utrdi svoje branike, stopi v glino in gneti ilovico, vzemi v roke okvir za opeko!",
			"15": "<sup>15</sup> Tam te bo požrl ogenj, posekal te bo meč, požrl te bo kakor kobilica skakalka. Razmnôži se kakor kobilica skakalka, razmnôži se kakor kobilica rojivka!",
			"16": "<sup>16</sup> Pomnožila si svoje trgovce bolj, kakor je zvezd na nebu. Kobilica skakalka dobi krila in odleti.",
			"17": "<sup>17</sup> Tvoji varuhi so kakor kobilice rojivke, tvoji častniki so kakor jata žuželk, ki sedi na plotovih, ko je mraz; ko vstane sonce, odlete in nihče ne ve za kraj, kjer so.",
			"18": "<sup>18</sup> Tvoji pastirji spijo, asirski kralj; tvoji junaki počivajo. Tvoje ljudstvo je razkropljeno po gorah in nikogar ni, ki bi ga zbral.",
			"19": "<sup>19</sup> Za tvoje razsutje ni olajšave, tvoja rana je huda. Vsi, ki bodo slišali o tebi, bodo z rokami ploskali nad teboj, kajti le nad kom se ni vselej znašala tvoja hudobija!"
		}
	}
};
module.exports = book;