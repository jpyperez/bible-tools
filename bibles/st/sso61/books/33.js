var book = {
	...
	"chapters": {
		...
		"4": {
			"1": "Mehleng ya bofelo, thaba ya ntlo ya Jehova e tla be e thewe qhoweng tsa dithaba, e okamele maralla, mme ditjhaba di tla phallela teng.",
			"2": "Ditjhaba tse ngata di tla ya, di re: Tloong, re nyolohele thabeng ya Jehova, tlung ya Modimo wa Jakobo, a tle a re rute ditsela tsa hae, re tsamaye ka mmila ya hae. Hobane molao o tla tswa Sione, lentswe la Jehova le tswe Jerusalema.",
			"3": "Mme Jehova o tla ahlolela ditjhaba tse ngata, a kgalemele merabe e matla, ho isa hole. Ka disabole tsa bona ba tla tea mehoma, ka marumo a bona ba tee disekele; setjhaba se seng se ke ke sa hlola se tsohela setjhaba se seng ka lerumo, ha ba sa tla hlola ba ithuta ntwa.",
			"4": "Ba tla dula e mong le e mong katlasa feiye ya hae le katlasa morara wa hae, ho se ya ba tshosang, hobane molomo wa Jehova wa makgotla o boletse.",
			"5": "Hobane ditjhaba kaofela di tsamaya se seng le se seng ka lebitso la modimo wa sona, empa rona, re tla tsamaya ka lebitso la Jehova, Modimo wa rona, kamehla le mehla.",
			"6": "Tsatsing leo, ho itswe ke Jehova, ke tla phutha se hlotsang, se lelekilweng ke se bokelle le seo ke se entseng hampe;",
			"7": "se hlotsang ke tla se etsa masala, se lahletsweng hole ke se etse setjhaba se matla, mme ho tloha moo, Jehova o tla ba busa thabeng ya Sione, ka ho sa yeng kae.",
			"8": "Haele wena, qhobosheane ya mohlape, leralla la moradi wa Sione, ho wena ho tla tla, ho be ho finyelle borena ba pele, e leng mmuso wa moradi wa Jerusalema.",
			"9": "Jwale, ke ka baka lang ha o howa ka mehoo? Na ha ho sa le morena ha hao na? Kapa na moeletsi wa hao o timetse, ha bohloko bo o tshwere jwaloka ba mosadi ya belehang?",
			"10": "Meneka, o utlwe bohloko, moradi wa Sione, jwaloka ya belehang; hobane jwale, o se o tla tswa hae, o tla dula naheng, o be o fihle Babilona. Empa teng o tla lokollwa; teng, Jehova o tla o lopolla matsohong a dira tsa hao.",
			"11": "Mme jwale, ditjhaba tse ngata di o bokanetse, di re: A a hlomphollwe, mahlo a rona a tle a bone kotsi ya Sione!",
			"12": "Empa ha di tsebe mehopolo ya Jehova, ha di utlwisise morero wa hae, hobane o di bokeletse jwaloka mangata a seotlong.",
			"13": "Tsoha, o pole, moradi wa Sione, hobane lenaka la hao ke tla le fetola tshepe, ditlhako tsa hao e be koporo, o tle o thuhake di tjhaba tse ngata; ke tla kgethela Jehova leruo la tsona, monono wa tsona ke o kgethele Morena wa lefatshe lohle."
		},
		"5": {
			...
			"3": "Ka baka leo, o tla ba neela dira, ho tle ho be ho fihle nako eo mobelehi a tla beleha ka yona; mme banababo ba setseng ba tla be ba kgutle hammoho le bara ba Iseraele.",
		...
		"6": {
			"1": "Utlwang he seo Jehova a se bolelang: Ema, o tseke pontsheng ya dithaba, maralla le wona a utlwe lentswe la hao!",
			"2": "Lona dithaba, utlwang nyewe ya Jehova, le utlwe le lona metheo e tiileng ya lefatshe; hobane nyewe e teng pakeng tsa Jehova le setjhaba sa hae, mme o tseka le Iseraele; o re:",
			"3": "Setjhaba sa ka, ke entseng ho wena? Ke o tubile kang? Nkarabele hle!",
			"4": "Ke o ntshitse lefatsheng la Egepeta, ke o lopolotse tlung ya bohlanka, ka ba ka o etella pele ka Moshe le Aarone le Miriame.",
			"5": "Setjhaba sa ka, hopola hle seo Balake, morena wa Moabe, a neng a se rerile, le seo Balaame, mora Beore, a mo arabetseng sona, le tse hlahileng ho tloha Sittime ho ya fihla Gilgale, o tle o tsebe ketso tse lokileng tsa Jehova.",
			"6": "Ke tla kgahlanyetsa Jehova kang, ke iname pela Modimo o phahameng? Na ke tla mo kgahlanyetsa ka ditjheso le ka manamane a selemo se le seng?",
			"7": "Na Jehova o tla kgahlwa ke pheleu tse dikete, ke mashome a dikete a dinoka tsa ole? A ke tla ntsha mora wa ka wa letsibolo bakeng sa bokgopo ba ka, ke ntshe ya tswileng maleng a ka bakeng sa sebe sa moya wa ka na?",
			"8": "Wena motho, o tsebisitswe se leng molemo, le seo Jehova a se batlang ho wena, ke hore o etse se lokileng, o rate bokgabane, le ho tsamaya ka boikokobetso le Modimo wa hao.",
			"9": "Lentswe la Jehova le howeletsa motse. Ya bohlale o tla hlokomela lebitso la hao, ha o re: Elang thupa hloko le ya e laelang.",
			"10": "Na matlotlo a bokgopo a sa le teng tlung ya ya sa lokang, le tekanyo e fokotsehileng, e rohakilweng na?",
			"11": "Na nka ba ya hlwekileng, ha ke lekanya ka sekala se kgopo, ke ena le majwe a thetso ka mokotleng?",
			"12": "Barui ba motse ona ba tletse bolotsana, baahi ba wona ba bolela leshano, leleme la bona ke bohata molomong wa bona.",
			"13": "Haele nna, ke se ke ya o otla habohloko, ke o senye ka baka la dibe tsa hao.",
			"14": "Wena, o tla ja, empa o ke ke wa kgora, mme tlala e tla dula maleng a hao; o tla re o a balehisa, empa o ke ke wa pholosa, mme seo o ka se pholosang ke tla se neela lerumo!",
			"15": "O tla jala, empa o ke ke wa kotula; o tla nepola ditholwana tsa mohlwaare, empa o ke ke wa tlola ole, o tla hlotlha metsi a morara, empa o ke ke wa nwa veine ...",
			"16": "Ho ntse ho bolokwa ditaelo tsa Omri le metsamao yohle ya ntlo ya Akabe! le ya ka merero ya bona, hore ke o etse tshenyeho, ke etse le baahi ba Jerusalema sesomo! mme le tla jara sekgobo sa setjhaba sa ka."
		},
		"7": {
