var book = {
	...
	"chapters": {
		...
		"4": {
			"1": "Mora Saule, ha a utlwa hobane Abnere o timetse Hebrone, matsoho a hae a tepella, le Baiseraele bohle ba tshoha.",
			"2": "Mora Saule o ne a na le banna ba le babedi, balaodi ba makgotla; e mong lebitso le hae e ne e le Baana, bitso la e mong e le Rekabe, e le bara ba Rimmone wa Beerothe, wa bana ba Benjamine. Ke ha Beerothe o se o balwa le metse ya Benjamine;",
			"3": "hobane ba Beerothe ba pele ba ne ba balehetse Gitthaime, ya eba bajaki ba teng ho fihlela kajeno.",
			"4": "Haele Jonathane, mora Saule, mora hae e mong o ne a le teng, ya holofetseng maoto; o ne a le dilemo tse hlano mohla ho fihlang pehi ya kamoo Saule le Jonathane ba shwetseng kateng, Jisreele. Mopepi wa hae o ne a mo nkile, a baleha le yena; ka baka la ho potlaka, ha a baleha, ngwana a wa, a ba a holofala maoto; bitso la hae e ne e le Mefiboshethe.",
			"5": "Rekabe le Baana, bara ba Rimmone wa Beerothe, ba tla, ba kena e sa le motshehare tlung ya Ishe-Boshethe, a robetse diphateng, e le motshehare o moholo.",
			"6": "Ba kena harehare ho ntlo, eka ba batla koro, ba mo hlaba mpeng; Rekabe le Baana ngwanabo ba ntoo baleha.",
			"7": "Ba ne ba mo kenetse tlung, a robetse diphateng, phaposing ya hae ya ho robala, ba mo hlaba teng, ba mmolaya, ba mo kgaola le hlooho, mme ba nka hlooho ya hae, ba ya le tsela ya thota bosiu bohle.",
			"8": "Ba tlisetsa Davida hlooho ya Ishe-Boshethe Hebrone, ba re ho morena: Ke ena hlooho ya Ishe-Boshethe, mora Saule, eo e neng e le sera ho wena se pheheletseng ho o bolaya; kajeno lena, Jehova o pheteleditse morena, monga ka, ho Saule le ho bana ba hae.",
			"9": "Davida a fetola Rekabe le Baana ngwanabo, bara ba Rimmone wa Beerothe, a re ho bona: Ka Jehova ya utlwang, ya namoletseng moya wa ka ditsietsing tsohle tsa ka, mohla e mong a neng a mphehela a re:",
			"10": "Bona, Saule o timetse; a lekanya eka o ntsebisa tse tla nthabisa; ka mpa ka mo tshwara, ka mmolaela Tsiklage, ya eba hona moputso wa peho ya hae.",
			"11": "Ke tla etsa jwalo hakakang ka lona, banna ba babe, ha le bolaile motho ya lokileng, tlung ya hae, a robetse diphateng tsa hae; ke tla batla madi a hae jwale matsohong a lona, ke le fedise lefatsheng!",
			"12": "Yaba Davida o laela bahlankana, ba tla, ba ba bolaya, ba ba poma matsoho le maoto, ba ntoo ba fanyeha pela letsha le Hebrone; haele hlooho ya Ishe-Boshethe, ba e nka, ba e epela lebitleng la Abnere, Hebrone."
		},
		"5": {
			"1": "Yaba meloko yohle ya Iseraele e tla ho Davida, Hebrone, ba bolela, ba re: Bona, re masapo a hao le nama ya hao.",
			"2": "Maoba le maobane, Saule haesale morena wa rona, e be e le wena ya futuhisang Baiseraele le ho ba orosetsa hae, le Jehova o kile a re ho wena: O tla disa setjhaba sa ka sa Iseraele, o be molaodi wa Iseraele.",
			"3": "Baholo bohle ba Iseraele ba tla jwalo ho morena, Hebrone, mme morena Davida a hlaba selekane le bona Hebrone, pela Jehova, mme teng ba tlotsa Davida, hore e be morena wa Iseraele.",
			"4": "Davida o ne a le dilemo tse mashome a mararo, ha a qala ho busa; mme a busa ka dilemo tse mashome a mane.",
			"5": "A busa Juda, a le Hebrone, ka dilemo tse supileng tse nang le dikgwedi tse tsheletseng, mme a busa Iseraele kaofela le Juda ka dilemo tse mashome a mararo a metso e meraro, a le Jerusalema.",
			"6": "Mohlang oo, morena le banna ba hae ba futuhela Jerusalema, ho ya lwantsha Bajebuse ba neng ba ahile fatsheng la teng. Bajebuse ba bolella Davida, ba re: O ke ke wa kena kwano; esita le difofu le dihole di ka o leleka. E be e le ho re, Davida a ke ke a kena teng.",
			"7": "Leha ho le jwalo, Davida a kena qhobosheane ya Sione; ke wona motse wa Davida.",
			"8": "Davida a re tsatsing leo: Ya tla qhala Bajebuse, a be a fihle forong ya metsi ho dihole le difofu tse hloilweng ke pelo ya Davida, o tla hlohonolofala. Ke ka baka leo ho thweng: Difofu le dihole ke tseo, a ke ke a kena hae ha tsona.",
			"9": "Davida a aha qhobosheaneng, mme a e rea lebitso la motse wa Davida. Davida a haha le lerako le teelang qhobosheane hare, le tlohang Millo, ho ya fihla hare.",
			"10": "Davida a nna a ya a hola, mme Jehova, Modimo wa makgotla, a nna a ba le yena.",
			"11": "Le yena Hirame, morena wa Tire, a romela Davida manqosa, le difate tsa dikedare, le dibetli tsa difate, le dibetli tsa majwe; tsa hahela Davida ntlo.",
			"12": "Davida a tseba kahoo hoba Jehova o mo tiisitse ho ba morena wa Iseraele, le hobane o phahamisitse borena ba hae ka baka le setjhaba sa hae sa Iseraele.",
			"13": "Jwale Davida, hobane a tlohe Hebrone, a eketsa a nka direthe le basadi Jerusalema; Davida a boela a tswallwa bara le baradi.",
			"14": "Ke ana mabitso a ba tswaletsweng yena a le Jerusalema: Ke Shammua, le Shobabe, le Nathane, le Salomone;",
			"15": "le Jibhare, le Elishua, le Nefege, le Jafia;",
			"16": "le Elishama, le Eliada, le Elifelethe.",
			"17": "Bafilesta ha ba utlwa hore Davida o tlotsitswe ho ba morena wa Iseraele, ba futuha bohle ho ya lwantsha Davida; mme Davida ha a utlwa, a kena qhobosheaneng.",
			"18": "Bafilesta ha ba fihla, ba rasa kgohlong ya Barefaime.",
			"19": "Ebile Davida a botsa Jehova, a re: Na ke tla nyolohela mo lwantsha Bafilesta? Na o tla ba neela matsohong a ka na? Jehova a re ho Davida: Nyoloha, hobane ruri ke tla neela Bafilesta matsohong a hao.",
			"20": "Yaba Davida o ya Baale-Peratsime, mme Davida a ba qhala teng, a re: Jehova o entse sekgeo direng tsa ka, jwalokaha metsi a ka etsa sekgeo. Ka baka leo, lebitso la teng le bitswa Baale-Peratsime (thota ya dikgeo).",
			"21": "Teng, Bafilesta ba lahla le ditshwantsho tsa medimo ya bona, mme Davida le banna ba hae ba ya le tsona.",
			"22": "Bafilesta ba boela ba futuha hape, ba rasa kgohlong ya Barefaime.",
			"23": "Davida ha a botsa Jehova, Jehova a re: O se ke wa ya pontsheng; o ba pote kamorao, mme o ba seeletse maloka le difate tsa monokotswai.",
			"24": "Etlere ha o utlwa modumo wa diqi dintlheng tsa difate tsa monokotswai, o ke o ba nehelle; hobane etlaba Jehova o se a o eteletse pele, ho ya qhala makgotla a Bafilesta.",
			"25": "Davida a etsa jwalokaha Jehova a mo laetse, mme a qhala Bafilesta, ho tloha Gibea, ho ya fihla Gesere."
		},
		"6": {
			"1": "Davida a boela a phutha ba kgethilweng bohle ba bahlabani ba Iseraele, a etsa dikete tse mashome a mararo.",
			"2": "Davida a tloha, a ena le setjhaba sohle seo a nang le sona, a ya Baale-Juda, ho lata areka ya Modimo teng, eo lebitso la Jehova wa makgotla ya dutseng pakeng tsa dikerubime le bitswang ho yona.",
			"3": "Ba kenya areka ya Modimo koloing e ntjha, ha ba se ba e ntshitse tlung ya Abinadabe e leralleng. Ussa le Akio, bara ba Abinadabe, ba ne ba tsamaisa koloi eo e ntjha.",
			"4": "Ba e ntsha tlung ya Abinadabe e leralleng, e nkile areka ya Modimo, mme Akio a etella areka pele.",
			"5": "Davida le bohle ba ntlo ya Iseraele ba letsa pela Jehova ka diletsa tsa mefutafuta tse entsweng ka difate tsa kiprese, ka diharepa, le diviole, le meropa, le diterompeta, le disimbala.",
			"6": "Ha ba fihla seotlong sa Nakone, Ussa a isa letsoho arekeng ya Modimo, a e tshwara, kahobane dipholo di ne di kgoptjwa.",
			"7": "Ebile Jehova o halefela Ussa, mme Modimo wa mmolaela hona teng ka molato oo; a shwela teng pela areka ya Modimo.",
			"8": "Empa Davida a swaba ke hobane Jehova a entse sekgeo Iseraeleng, ka ho bolaya Ussa; ka baka lena, bitso la teng a le bitsa Peretse-Ussa (sekgeo sa Ussa); le kajeno ke la teng.",
			"9": "Tsatsing leo, Davida a tshaba Jehova, a re: Areka ya Jehova e ka tla jwang ha ka?",
			"10": "Davida a hana ke hona ho isa areka ya Jehova ha hae motseng wa Davida, a e faposetsa tlung ya Obed-Edomo wa Gathe.",
			"11": "Areka ya Jehova ya dula ha Obed-Edomo wa Gathe kgwedi tse tharo; mme Jehova a hlohonolofatsa Obed-Edomo le ntlo ya hae kaofela.",
			"12": "Morena Davida a tsebiswa, ha thwe: Jehova o hlohonolofaditse ntlo ya Obed-Edomo le tsohle tsa hae, ka baka la areka ya Modimo. Yaba Davida o ya lata areka ya Modimo ha Obed-Edomo, a e tlisa motseng wa Davida a thabile.",
			"13": "Enere ba jereng areka ya Jehova ha ba hatile hatshelela, ho ne ho hlajwa kgomo le namane e nonneng.",
			"14": "Haele Davida, o ne a hobela ka matla wohle a hae pela areka ya Jehova; mme Davida o ne a apere efoda ya lene.",
			"15": "Davida le bohle ba ntlo ya Iseraele ba tsamaisa areka ya Jehova jwalo, ka ditlatse le ka ho letsa diterompeta.",
			"16": "Areka ya Jehova ha e fihla motseng wa Davida, Mikale, moradi wa Saule, ha a nyarela ka fensetere, a bona morena Davida a tlolaka, a hobela pela Jehova, mme a mo nyedisa ka pelong ya hae.",
			"17": "Ha ba fihla le areka ya Modimo, ba e bea tulong tsa yona, tenteng eo Davida a e hlometseng yona, mme Davida a boela a hlaba mahlabelo a ditjheso le a teboho pela Jehova.",
			"18": "Eitse hobane Davida a qetelle ho hlaba mahlabelo a ditjheso le a teboho, a hlohonolofatsa setjhaba ka lebitso la Jehova wa makgotla.",
			"19": "A ba a abela setjhaba sohle, e leng bongata bohle ba Iseraele, banna le basadi, e mong le e mong, polokwe ya bohobe, le sesuma sa nama e besitsweng, le senkgwa sa morara. Setjhaba sa ntoo ikela e mong hae ha hae.",
			"20": "Davida le yena a boela hae ho ya hlohonolofatsa ntlo ya hae. Mikale, moradi wa Saule, a tswela ho ya kgahlanyetsa Davida, a re: Morena wa Iseraele o itlhomphile hakakang, ha a hlobotse kajeno pontsheng ya makgabunyane a bahlanka ba hae, jwalokaha ho ka hlobola motho wa lefeela!",
			"21": "Davida a re ho Mikale: Ke entse jwalo pela Jehova ya nkgethileng bakeng sa ntatao le bakeng sa bohle ba ntlo ya hae, hore a mpee motsamaisi wa setjhaba sa Jehova, sa Iseraele; ke ka baka leo ke ratang ho hobela pela Jehova;",
			"22": "mme ke tla nne ke eketse, ke ipee lefeela ho feta le kajeno, ke nne ke iketse e monyenyane mahlong a ka; haele makgabunyane ao o a boletseng, wona a tla ntlhonepha.",
			"23": "Mikale, moradi wa Saule, ha a ka a tswala bana le ho isa tsatsing la ho shwa ha hae."
		},
		"7": {
		...
		"8": {
			"1": "Kamora tseo, Davida a fenya Bafilesta a ba kokobetsa, a amoha Bafilesta motse o mong wa moreneng.",
			"2": "A hlola le Bamoabe, a ba lekanya ka kgole a ba robaditse fatshe, a ba lekanya bolelele ba kgole tse pedi tsa ba tshwanetseng ho bolawa, mme ka kgole e le nngwe e shwetseng a lekanya ba tshwanetseng ho phela. Kahoo, Bamoabe ya eba bafo ba Davida, ba mo ntshetsa lekgetho.",
			"3": "Davida a hlola le Hadadesere, mora Rehobe, morena wa Tsoba, ya neng a re, o tla boela a hape naha e leng ya hae nokeng ya Eufrate.",
			"4": "Teng, Davida a hapa sekete se nang le makgolo a supileng a bapalami, le kete tse mashome a mabedi tsa ba maoto. Davida a seha mesifa ya maoto a dipere tsohle tsa makoloi, a ipolokela tsa lekgolo la makoloi feela.",
			"5": "Basiria ba Damaseka ba ne ba tlile ho tlatsa Hadadesere, morena wa Tsoba; Davida a bolaya Basiria ba kete tse mashome a mabedi a metso e mmedi.",
			"6": "Davida a ntoo bea bahlabani naheng ya Siria ya Damaseka, mme Basiria ya eba bafo ba Davida, ba mo ntshetsa lekgotho. Jehova a nna a boloka Davida jwalo hohle moo a yang.",
			"7": "Davida a hapa le dithebe tsa kgauta tse ho bahlanka ba Hadadesere, a tla le tsona Jerusalema.",
			"8": "Leha e le Betha, le Berothai, metse ya Hadadesere, morena Davida a nka koporo e ngata haholo teng.",
			"9": "Thoi, morena wa Hamathe, a utlwa hobane Davida o hlotse makgotla wohle a Hadadesere.",
			"10": "Yaba Thoi o romela mora hae Jorame ho morena Davida, ho ya mo dumedisa le ho mo leboha kamoo a lwantshitseng Hadadesere kateng, a bileng a mo hlotse, hobane Hadadesere o ne a lwantsha Thoi. Jorame a tlisa mesebetsi ya silefera, le ya kgauta, le mesebetsi ya koporo.",
			"11": "Le tsona morena Davida a di kgethela Jehova, hammoho le silefera le kgauta tseo a di kgethileng tsa ditjhaba tsohle tseo a di hlotseng;",
			"12": "e leng Basiria, le Bamoabe, le bana ba Ammone, le Bafilesta, le Baamaleke, ka tse hapilweng tsa Hadadesere, mora Rehobe, morena wa Tsoba.",
			"13": "Davida a iketsetsa lebitso le leholo, ha a kgutla polaong ya Basiria, Thoteng ya Letswai, a bolaile batho ba dikete tse leshome le nang le metso e robileng meno e le mmedi.",
			"14": "A bea bahlabani Edomo; kahohle Edomo, a bea bahlabani, le Baedomo bohle ya eba bafo ba Davida. Jehova a nna a boloka Davida jwalo hohle moo a yang.",
			"15": "Davida ya eba morena wa Baiseraele bohle, mme Davida a etsa setjhaba sohle ka ho loka le ka bokgabane.",
			"16": "Joabe, mora Tseruja, e ne e le molaodi wa makgotla; Josafate, mora Akilude, e ne e le mmoloki wa mangolo a mmuso;",
			"17": "Tsadoke, mora Akitube, le Akimeleke, mora Abiathare, e ne e le baprista; Seraia e ne e le mongodi;",
			"18": "Benaia, mora Jehojada, e ne e le molaodi wa Bakerethe le Bapelethe; bana ba Davida bona e ne e le matona a morena."
		},
		"9": {
		...
		"10": {
			"1": "Kamora tseo, morena wa bana ba Ammone a timela, mme Hanune, mora hae, ya eba morena tulong tsa hae.",
			"2": "Yaba Davida o re: Ke tla etsa Hanune, mora Nahashe, hantle, kamoo le ntatae a kileng a nketsa hantle kateng. Kahoo, Davida a roma bahlanka ba hae ho ya mo tshedisa bakeng sa ho shwa ha ntatae. Bahlanka ba Davida, ha ba fihla naheng ya bana ba Ammone,",
			"3": "baholo ba bana ba Ammone ba re ho Hanune, morena wa bona: Ha Davida a rometse batshedisi ho wena, hleka o re, ke ka ho hlonepha ntatao na? Ha Davida a rometse bahlanka ba hae ho wena, hleka hase ho tla qamakisisa le ho hlwela motse, hore a o timetse na?",
			"4": "Yaba Hanune o tshwara bahlanka ba Davida, a ba beola ditedu ka nqa e nngwe, a seha le diaparo tsa bona kalehare ho isa lethekeng, a ba a ba kgutlisa ba le jwalo.",
			"5": "Eitse hobane ba tsebise Davida, a romela ho ba kgahlanyetsa, hobane banna bao ba ne ba le dihlong haholo; mme morena a re: Dulang Jeriko, ditedu tsa lona di be di mele, le ntoo boya.",
			"6": "Bana ba Ammone ba bona hobane ba ikentse ba nkgang hampe ho Davida; yaba bana ba Ammone ba romela ho mema Basiria ba Bethe-Rehobe, le Basiria ba Tsoba, e le batho ba mashome a mabedi a dikete ba maoto, ba morena wa Maaka e le ba sekete se le seng, le ba Tobe e le ba dikete tse leshome le metso e mmedi.",
			"7": "Davida ha a utlwa, a roma Joabe le sera sohle sa banna ba ntwa.",
			"8": "Jwale, bana ba Ammone ba tswa, ba hlopholla ntwa pela kgoro ya motse; Basiria ba Tsoba le ba Rehobe, le ba Tobe, le ba Maaka, ba dula tulong tsa bona naheng.",
			"9": "Joabe ha a bona hobane ntwa e ya mo tlela, e nngwe e le kapele, e nngwe e le kamorao, a kgetha mokgetho wohle wa Iseraele, a ba lokisa hore ba kopanye ntwa le Basiria.",
			"10": "Ba bang ba setseng a ba nea Abishai moenae, hore a ba lokise ho ya kopanya ntwa le bana ba Ammone.",
			"11": "Joabe a re ho yena: Ha Basiria ba ka nkimela, o tle o tlatsetse ho nna; ha bana ba Ammone ba o imela, ke tla tlatsetsa ho wena.",
			"12": "Etsa ka senna, o iphe matla ho lwanela setjhaba sa heso le metse ya Modimo wa rona, mme Jehova a ke a etse kamoo a ratang kateng.",
			"13": "Joabe a ntoo atamela le batho bao a nang le bona ho ya lwantsha Basiria, mme ba baleha pela hae.",
			"14": "Bana ba Ammone, ha ba bona hobane Basiria ba balehile, le bona ba baleha pela Abishai, ba kena hae motseng. Yaba Joabe o kgutla ntweng ya bana ba Ammone, a boela Jerusalema.",
			"15": "Basiria, eitse ha ba bona hobane ba hlotswe ke Baiseraele, ba boela ba phutheha.",
			"16": "Hadadesere a romela ho lata Basiria ba mose wane ho noka, ba tla Helame; Shobake, molaodi wa sera sa Hadadesere, e le motsamaisi wa bona.",
			"17": "Davida ha a tsebiswa, a phutha Baiseraele bohle, a tshela Jordane, a tla Helame; le bona Basiria ba lokisa ntwa ho ya kgahlanyetsa Davida, le ho mo lwantsha.",
			"18": "Basiria ba baleha pela Baiseraele, mme Davida a timetsa makgolo a supileng a makoloi, le bapalami ba kete tse mashome a mane; a bolaya le Shobake, molaodi wa sera sa Hadadesere, a shwela hona teng.",
			"19": "Marena wohle a neng a le taolong ya Hadadesere, ha a bona hobane ho hlotse Baiseraele, a etsa kgotso le Baiseraele, a ba sebeletsa, Basiria ba ba ba tshaba ho boela ba thusa bana ba Ammone."
		},
		"11": {
			"1": "Eitse hobane lemo seo se fete, ka nako eo marena a atisang ho futuha ka yona, Davida a roma Joabe le bahlanka ba hae le Baiseraele bohle, ba ya, ba senya lefatshe la bana ba Ammone, ba ntoo ya thibella Rabba. Haele Davida, a sala Jerusalema.",
			"2": "Ka tsatsi le leng, mantsiboya, Davida a tsoha diphateng tsa hae, a ya itsamaela hodima ntlo ya borena. Ha a le hodima ntlo, a bona mosadi ya tolang, e le mosadi e motle haholo.",
			"3": "Yaba Davida o romela ho botsa tsa mosadi eo. Ha thwe: Na hase Bathe-Sheba, moradi wa Eliame, mosadi wa Uria, Mohethe na?",
			"4": "Yaba Davida o romela manqosa ho mo lata; mosadi ha a fihla ho yena, Davida a robala le yena; hobane a itlhatswe ditshila tsa hae, a ipoella ha hae.",
			"5": "Mosadi eo a dula; mme a romela ho tsebisa Davida, a re: Ke moimana.",
			"6": "Yaba Davida o romela ho Joabe, a re: Nthomele Uria, Mohethe. Joabe a romela Uria ho Davida.",
			"7": "Uria ha a fihla, Davida a mmotsa tsa Joabe le setjhaba, le tsa ntwa.",
			"8": "Davida a ba a re ho Uria: Ikele hae, o itlhatswe maoto. Uria a tswa tlung ya morena, mme mpho ya morena ya mo sala morao.",
			"9": "Empa Uria a robala monyako wa ntlo ya morena, hammoho le bahlanka bohle ba monga hae, a se ke a kena tlung ya hae.",
			"10": "Davida a tsebiswa, ha thwe: Uria ha a ka a kena tlung ya hae. Ebile Davida o re ho Uria: Ha ke re, o tswa eta na? Ho ya kang, ha o sa ka wa kena tlung ya hao na?",
			"11": "Uria a re ho Davida: Areka le Baiseraele, le Bajuda, ba dutse metlotlwaneng; le monga ka Joabe, le bahlanka ba morena ka ba emisitse hara naha; ha ho le jwalo, nka kena jwang tlung ya ka, le ho ja, le ho nwa, le ho robala le mosadi wa ka? Ka ho phela ha hao, le ka moya wa hao o phelang, nke ke ka etsa jwalo.",
			"12": "Davida a re ho Uria: Dula kwano le kajeno; hosasane, ke tla o fa tsela. Kahoo, Uria a dula Jerusalema letsatsi lena, le la hosasane.",
			"13": "Davida a boela a mmitsa, mme Uria a ja, a nwa pela hae, a tahiswa ke yena; a tswa mantsiboya ho ya robala phateng tsa hae hara bahlanka ba monga hae, a se ke a kena tlung ya hae.",
			"14": "Hosasa, Davida a ngolla Joabe lengolo, a le romela ka Uria.",
			"15": "A ngola lengolo la ho re: O ke o laolele Uria ka pele moo ntwa e lohlaneng; le suthe pela hae, a tle a bolawe, a shwe.",
			"16": "Kahoo, Joabe a qamaka motse, mme a bea Uria nakeng leo a tsebang hobane banna ba matla ba tla lwanela teng.",
			"17": "Banna ba motse ha ba etswa, ba lwana le Joabe, mme bahlanka ba bang ba Davida ba wa, le yena Uria Mohethe a shwa.",
			"18": "Yaba Joabe o romela ho tsebisa Davida taba tsohle tsa ntwa.",
			"19": "A laela lenqosa, a re: Ha o qetile ho bolella morena taba tsohle tsa ntwa,",
			"20": "ha morena a ka tshoha a halefa, a re ho wena: Na le ne le sa tsebe hobane ba tla fula ba le ka lerakong na?",
			"21": "Ke mang ya bolaileng Abimeleke, mora Jerubbeshethe? na hase mosadi ya kileng a akgela lejwe la lelwala, a le ka lerakong, Abimeleke a ba a shwela Thebetse na? ho ya kang, ha le atametse lerako hakalo na? Etlaba moo o reng: Le mohlanka wa hao Uria Mohethe o shwele.",
			"22": "Lenqosa la ya ka tseo, la fihla, la tsebisa Davida tsohle tseo Joabe a le romileng ka tsona.",
			"23": "Lenqosa la re ho Davida: Banna ba Rabba ba fela ba re imetse, ba tla ho rona, re le naheng, ra mpa ra ba busa, ho ya fihla kgorong.",
			"24": "Bafudi ba mpa ba fula bahlanka ba hao, ba le ka lerakong, mme bahlanka ba bang ba morena ba shwele, le yena Uria Mohethe, mohlanka wa hao, o timetse.",
			"25": "Davida a re ho lenqosa: E re ho Joabe: O se ke wa tshoha ke taba ena; sabole e ye e je e mong mona, e boele e je e mong kahosele; ako tiisetse ho lwantsha motse, o o heletse. O ke o mo kgothatse ka tseo.",
			"26": "Mosadi wa Uria, ha a utlwa hobane monna wa hae Uria o shwele, a rwalla monna wa hae thapo.",
			"27": "Hobane a role thapo, Davida a romela ho mo nkela ha hae, ya eba mosadi wa hae, a ba a mo tswalla moshemane. Empa taba ena, e entsweng ke Davida, ya eba mpe mahlong a Jehova."
		},
		"12": {
		...
		"19": {
			...
			"8": "Ebile morena o tsoha, a ya dula kgorong, mme setjhaba sohle sa tsebiswa, ha thwe: Bonang, morena o dutse kgorong; mme setjhaba sohle sa itlisa teng pela morena. Haele Baiseraele, ba ne ba balehetse e mong le e mong hae tenteng ya hae.",
		...
		"23": {
			"1": "Mantswe a mang a Davida a ho qetella ke wona ana: Ho bolela Davida, mora Jese; ho bolela monna ya phahamiseditsweng hodimo, motlotsuwa wa Modimo wa Jakobo, moroki ya kgahlehang wa Iseraele.",
			"2": "Moya wa Jehova o bua ka nna, lentswe la hae le lelemeng la ka.",
			"3": "Modimo wa Iseraele o buile, Lefika la Iseraele le mpoleletse, la re: Ya busang batho ka ho loka, ya renang ka ho tshaba Modimo,",
			"4": "o jwaloka lesedi la meso, ha tsatsi le tjhaba, ha meso e se na maru; pula ha e tswa na, mahlasedi a lona a medisa jwang lefatsheng.",
			"5": "Ha ke re, ntlo ya ka e jwalo pela Modimo, hobane o hlabile le nna selekane se sa feleng, se lokileng kahohle, se tiileng! Ha ke re, o tla medisa polokeho ya ka yohle le tsohle tse lakatswang ke nna!",
			"6": "Haele ba bolotsana, kaofela ha bona ba ka meutlwa e lahlwang, e se nang ho tshwarwa ka letsoho;",
			"7": "eo monna ya e amang, e ka kgonang a tshware selepe kapa theko ya lerumo; mme e tjhesetswa ka mollo hona moo e leng teng.",
			"8": "Ke ana mabitso a dinatla tsa Davida: Joshebe-Bashebethe, wa Thakhemone, hlooho ya balaodi. A betsa ka lerumo la hae, mme ka tsatsi le le leng, a hlaba batho ba makgolo a robileng meno e le mmedi.",
			"9": "Ya mo hlahlamang ke Eleasare, mora Dodai, wa Akoke; ke e mong wa dinatla tse tharo tsa pele, tse nnileng tsa ya le Davida, li sa tshabe Bafilesta mohla ba phuthehileng ka ntwa, banna ba Iseraele ha ba balehetse maralleng.",
			"10": "Yena a ema, a bolaya Bafilesta, ha ba ha kgathala letsoho la hae, la kgomarela sabole. Ke ka yena Jehova a namoletseng Baiseraele haholo mohlang oo, setjhaba sa ba sa kgutla le yena e le hore se hape feela.",
			"11": "Ya mo hlahlamang, ke Shamma, mora Age, wa Harare. Bafilesta ba ne ba phuthehile Lehi, moo tshimo e leng teng e tletseng dinawa; setjhapa sa baleha pela Bafilesta.",
			"12": "Eo a mpa a ema bakeng seo, a lwanela setjhaba, a bolaya Bafilesta. Jehova a namolela Baiseraele haholo le ka yena.",
			"13": "Ba bararo ba dinatla tse mashome a mararo, ba theoha, ba fihla ho Davida, lehaheng la Adullame, mohla ho kotulwang; ntwa ya Bafilesta e ne e emisitse sekgutlong sa Barefaime.",
			"14": "Davida yena o ne a le seqhobong, mme sehlopha sa Bafilesta se ne se le Bethlehema.",
			"15": "Davida a lakatsa, a re: Ke mang ya tla nnosa metsi a sediba sa Bethlehema, se kgorong?",
			"16": "Bahale bao ba bararo ba ya, ba phunyaka makgotla a Bafilesta, ba ya kga metsi sedibeng sa Bethlehema se kgorong; ba a kga, ba tla le wona ho Davida; a mpa a hana ho a nwa, a a tshollela Jehova,",
			"17": "a re: Oho Jehova, a nke ke se ke ka etsa hoo; ha ke re, ke madi a banna bao ba ileng, ba tedile ho phela ha bona? Kahoo, a hana ho a nwa. Hoo ha etswa ke bahale bao ba bararo.",
			...
			"19": "Ho ba bararo, ya eba yena ya roriswang; ya eba monga bona ke hona, a mpa a sa fihle ho ba bararo ba pele.",
			"20": "E mong ke Benaia, mora Jehojada, mora mohale e mong wa Kabtseele; a ba moholo ka diketso tsa hae. A bolaya tau tse pedi tse matla tsa Moabe; a boela a theoha, a bolaya tau e nngwe lemeneng, mohla lehlwa le kgethehang.",
			"21": "A bolaya le monna wa Moegepeta, ya sebopeho se tshabehang; leha Moegepeta a ne a tshwere lerumo letsohong la hae, yena Benaia a theohela ho yena ka molamu, a rutla lerumo letsohong la Moegepeta, a ba a mmolaya ka lona lerumo leo la hae.",
			"22": "Tseo tsa etswa ke Benaia, mora Jehojada; a iketsetsa lebitso hara bahale bao ba bararo.",
			"23": "Ho ba mashome a mararo, ya eba yena ya roriswang, a mpa a se ke a fihla ho ba bararo ba pele. Davida a mmea monna wa lekgotla la hae.",
			"24": "Asaele, ngwanabo Joabe, e ne e le e mong wa ba mashome a mararo; le Elkanane, mora Dodo wa Bethlehema;",
			"25": "le Shamma, wa Harode, le Elika wa Harode;",
			"26": "le Heletse Mopelethe, le Ira, mora Ikkeshe, wa Tekowa;",
			"27": "le Abiesere wa Anathothe, le Mebunnai wa Husha;",
			"28": "le Tsalmone wa Akowa, le Maharai wa Nethofa;",
			"29": "le Helebe, mora Baana, wa Nethofa, le Ittai, mora Ribai, wa Gibea wa bana ba Benjamine;",
			"30": "le Benaia wa Pirathone, le Hiddai wa Nahale-Gaashe;",
			"31": "le Abi-Albone wa Araba, le Asmavethe wa Barkume;",
			"32": "le Eliaba wa Shaalbone, le Bene-Jashene, le Jonathane;",
			"33": "Shamma wa Harare, le Akiame, mora Sharare, wa Harare;",
			"34": "le Elifelethe, mora Akasbai, mora Momaakathe; le Eliame, mora Akitofele, wa Gilo;",
			"35": "le Hetsrai wa Karmele, le Paarai Moarabe;",
			"36": "le Jigeale, mora Nathane, wa Tsoba, le Banie wa Gade;",
			"37": "le Tseleke Moammone, le Naharai wa Beerothe, lehlahana la Joabe mora Tseruja.",
			"38": "Hape, ke Ira wa Jethere, le Garebe wa Jethere,",
			"39": "le Uria Mohethe. Kaofela ha bona ba mashome a mararo a metso e supileng."
		},
		"24": {
			"1": "Jehova a boela a halefela Baiseraele, mme a ba a susumelletsa Davida, a re: Eya, o bale Iseraele le Juda.",
			"2": "Morena a laela Joabe, molaodi wa makgotla, eo a nang le yena, a re: Eya le meloko yohle ya Iseraele, ho qala ka Dane, le ho ya fihla Beerseba, o bale setjhaba, ke tle ke tsebe bongata ba setjhaba.",
			"3": "Joabe a re ho morena: Jehova, Modimo wa hao, a ke a atise setjhaba, se ke se fete boholo ba sona ba jwale halekgolo, mahlo a morena, monga ka, a be a bone; empa morena, monga ka, o lakaletsang ntho eo?",
			"4": "Leha ho le jwalo, taelo ya morena ya hlola Joabe le balaodi ba bang ba makgotla, mme Joabe le balaodi ba bang ba makgotla ba tloha ho morena ho ya bala setjhaba sa Iseraele.",
			"5": "Ba ya, ba tshela Jordane, ba emisa Aroere, ho le letona ho motse o hara kgohlo ya Gade, nqa Jaesere.",
			"6": "Ba ntoo tla Gileade, le naheng ya Thahethime-Hodshi, ba ntoo fihla Dane-Jaane, le mathokong a Sidone.",
			"7": "Ba ntoo fihla qhobosheaneng ya Tire, le metseng yohle ya Baheve le ya Bakanana. Ha ba tloha teng, ba leba nqa borwa ho Juda, ho ya fihla Beerseba.",
			"8": "Eitse hobane ba potapote jwalo le naha yohle, ba kgutlela Jerusalema, ho se ho fetile kgwedi tse robileng mono o le mong tse nang le matsatsi a mashome a mabedi.",
			"9": "Yaba Joabe o nea morena palo ya bongata ba setjhaba; ho ne ho le Iseraeleng kete tse makgolo a robileng meno e le mmedi tsa banna ba ntwa ba tsomolang sabole, banna ba Juda bona e le ba dikete tse makgolo a mahlano.",
			"10": "Eitse hobane Davida a bale setjhaba, letswalo la hae la mo loma, mme Davida a re ho Jehova: Ke sitilwe haholo ka seo ke se entseng. Oho Jehova, tlosa bokgopo ba mohlanka wa hao jwale; efela ke entse ka bothoto bo boholo.",
			"11": "Davida, ha a tsoha hosasa, lentswe la Jehova la tlela moporofeta Gade, seboni sa Davida,",
			"12": "la re: Eya, o re ho Davida: Ho thwe ke Jehova: Ke o behela taba tse tharo; ikgethele e nngwe ho tsona, ke o etse yona.",
			"13": "Gade ha a fihla ho Davida, a mo tsebisa, a re ho yena: Hleka o re, o tlelwe ke tlala ka dilemo tse supileng naheng ya hao; kapa o re, o tla baleha ka kgwedi tse tharo pela dira tsa hao, di ntse di o lelekisa; kapa o re, ho tle lefu la sewa naheng ya hao ka tshiu tse tharo na? Ikgethele jwale, o bone hore na ke tla busetsa taba efe ho ya nthomileng.",
			"14": "Davida a re ho Gade: Ke tsielehile haholo; a re mpe re wele matsohong a Jehova, etswe mehauhelo ya hae e le mengata; ke se ke ka wela matsohong a batho.",
			"15": "Ha ho le jwalo, Jehova a nehela Iseraele lefu la sewa, ho qala ka nako ya hosasa, ho fihla nakong e beilweng, le ho tloha Dane, ho isa Beerseba. Ha eshwa batho ba mashome a supileng a dikete hara setjhaba.",
			"16": "Lengeloi, eitse ha le lebisa letsoho la lona nqa Jerusalema hore le bolaye ba teng, Jehova a ba utlwela bohloko ka baka la tshenyeho, a re ho lengeloi le bolayang setjhaba: Ho lekane; honyetsa letsoho la hao jwale! Ke ha lengeloi la Jehova le ne le eme pela seotlo sa Arauna Mojebuse.",
			"17": "Davida, ha a bona lengeloi le bolayang setjhaba, a bolella Jehova, a re: Bona, ke nna ke entseng hampe; nku tseo tsona di entseng? Tsoho la hao le otle nna le ntlo ya ntate!",
			"18": "Tsatsing lona leo, Gade a tla ho Davida, a re ho yena: Eya, o hahele Jehova aletare seotlong sa Arauna Mojebuse.",
			"19": "Ka polelo ya Gade, Davida a ya, kamoo Jehova a laetseng kateng.",
			"20": "Eitse Arauna ha a tadima, a bona morena le bahlanka ba hae ba etla ho yena. Yaba Arauna o tloha, a ya, a inamela fatshe ka sefahleho pela morena.",
			"21": "Arauna a re: Morena, monga ka, o tletseng ho mohlanka wa hae? Davida a re: Ke tlile ho reka seotlo ho wena, ke tle ke hahele Jehova aletare teng, hore lefu le tlohe setjhabeng.",
			...
			"23": "Morena, Arauna o nea morena tseo tsohle. Arauna a eketsa a re ho morena: Jehova, Modimo wa hao, a ke a o hauhele!",
			"24": "Morena a re ho Arauna: Tjhe, ke tla mpe ke reke ho wena ka theko; nke ke ka hlahisetsa Jehova, Modimo wa ka, ditjheso tseo ke sa di ntshetsang letho. Ha ho le jwalo, Davida a reka seotlo le dipholo ka dishekele tsa silefera tse mashome a mahlano.",
			"25": "Teng, Davida a hahela Jehova aletare, a mo etsetsa ditjheso le mahlabelo a teboho. Yaba Jehova o hauhela naha, mme lefu la tloha Iseraeleng."
		}
	}
};
module.exports = book;