...
describe "Localized book Rev (hil)", ->
	...
	it "should handle book: Rev (hil)", ->
		...
		`
		true
describe "Localized book PrMan (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: PrMan (hil)", ->
		`
...
describe "Localized book Ruth (hil)", ->
	...
	it "should handle book: Ruth (hil)", ->
		...
		`
		true
describe "Localized book 1Esd (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: 1Esd (hil)", ->
		`
		expect(p.parse("1Esd 1:1").osis()).toEqual("1Esd.1.1")
		`
		true
describe "Localized book 2Esd (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: 2Esd (hil)", ->
		`
...
describe "Localized book Neh (hil)", ->
	...
	it "should handle book: Neh (hil)", ->
		...
		`
		true
describe "Localized book GkEsth (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: GkEsth (hil)", ->
		`
...
describe "Localized book Ps (hil)", ->
	...
	it "should handle book: Ps (hil)", ->
		...
		`
		true
describe "Localized book PrAzar (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: PrAzar (hil)", ->
		`
...
describe "Localized book 2Macc (hil)", ->
	...
	it "should handle book: 2Macc (hil)", ->
		...
		`
		true
describe "Localized book 3Macc (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: 3Macc (hil)", ->
		`
		expect(p.parse("3Macc 1:1").osis()).toEqual("3Macc.1.1")
		`
		true
describe "Localized book 4Macc (hil)", ->
	p = {}
	beforeEach ->
		p = new bcv_parser
		p.set_options book_alone_strategy: "ignore",book_sequence_strategy: "ignore",osis_compaction_strategy: "bc",captive_end_digits_strategy: "delete"
		p.include_apocrypha true
	it "should handle book: 4Macc (hil)", ->
		`
...
describe "Miscellaneous tests", ->
	...
	it "should return the expected language", ->
		expect(p.languages).toEqual ["hil"]

	it "should handle ranges (hil)", ->
		...
		expect(p.parse("Phlm 2 TUBTOB 3").osis()).toEqual "Phlm.1.2-Phlm.1.3"
	it "should handle chapters (hil)", ->
