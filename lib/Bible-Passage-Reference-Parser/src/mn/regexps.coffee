		...
		(
			...
			\x1f(\d+)(?:/\d+)?\x1f		#book
				(?:
				  ...
				  | [\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014]
				  | Гарчиг (?! [a-z] )		#could be followed by a number
				  | бүлэг | болон | шүлэг | ff | do
...
bcv_parser::regexps.range_and = "(?:[&\u2013\u2014-]|болон|do)"
...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["2Thess"]
		regexp: ///(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(
		(?:2(?:[\s\xa0]*Т(?:ес(?:алоник)?|с)|Thess))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1Thess"]
		regexp: ///(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(
		(?:1(?:[\s\xa0]*Т(?:ес(?:алоник)?|с)|Thess))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["2Tim"]
		regexp: ///(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(
