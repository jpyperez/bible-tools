...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["Num"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:Книга[\s\xa0]*Чисел|Числа|Числ?|Num)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Sir"]
		apocrypha: true
	...
	,
		osis: ["Prov"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:Книга[\s\xa0]*притче[ий][\s\xa0]*Соломоновых|Мудрые[\s\xa0]*изречения|Притчи|Пр(?:итч?)?|Мудр|Prov)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Eccl"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
	...
	,
		osis: ["2Pet"]
		regexp: ///(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(
		(?:2(?:\-?[ея](?:\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))|[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир)))а|[ея](?:\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))|[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир)))а|\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))а|[\s\xa0]*послание[\s\xa0]*Петра|[\s\xa0]*Петруса|[\s\xa0]*Петира|[\s\xa0]*Петра|[\s\xa0]*Петр?|Pet))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1Pet"]
		regexp: ///(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(
		(?:1(?:\-?[ея](?:\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))|[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир)))а|[ея](?:\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))|[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир)))а|\.[\s\xa0]*(?:послание[\s\xa0]*Петр|Пет(?:р(?:ус)?|ир))а|[\s\xa0]*послание[\s\xa0]*Петра|[\s\xa0]*Петруса|[\s\xa0]*Петира|[\s\xa0]*Петра|[\s\xa0]*Петр?|Pet))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Jude"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
