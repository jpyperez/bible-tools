...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["1Chr"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
		(?:1\.?[\s\xa0]*ବଂଶାବଳୀର)|(?:ବଂଶାବଳୀର[\s\xa0]*ପ୍ରଥମ[\s\xa0]*ପୁସ୍ତକ|ପ୍ରଥମ[\s\xa0]*ବଂଶାବଳୀର|ପ୍ରଥମ[\s\xa0]*ବଂଶାବଳୀ|1(?:\.[\s\xa0]*ବଂଶାବଳୀ|[\s\xa0]*ବଂଶାବଳୀ|Chr))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Ezra"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
	...
	,
		osis: ["1Cor"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
		(?:କରିନ୍ଥୀୟଙ୍କ[\s\xa0]*ପ୍ରତି[\s\xa0]*ପ୍ରଥମ[\s\xa0]*ପତ୍ର|ପ୍ରଥମ[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ|ପ୍ରଥମ[\s\xa0]*କରିନ୍ଥୀୟ|1(?:\.[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ|[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ|କରି|Cor)|1(?:\.[\s\xa0]*କରିନ୍ଥୀୟ|[\s\xa0]*କରିନ୍ଥୀୟ|କର))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Gal"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
	...
	,
		osis: ["Eph"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:ଏଫିସ(?:ୀୟଙ୍କ(?:[\s\xa0]*ପ୍ରତି[\s\xa0]*ପତ୍ର)?)?|Eph)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Phil"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
