...
describe "Localized book 2Cor (tl)", ->
	...
	it "should handle book: 2Cor (tl)", ->
		...
		expect(p.parse("Ikalawang Corinth 1:1").osis()).toEqual("2Cor.1.1")
...
describe "Localized book 1Cor (tl)", ->
	...
	it "should handle book: 1Cor (tl)", ->
		...
		expect(p.parse("Unang Corinth 1:1").osis()).toEqual("1Cor.1.1")
		...
		expect(p.parse("Una Corinth 1:1").osis()).toEqual("1Cor.1.1")
