(function() {
  ...
  describe("Localized book 2Sam (fa)", function() {
    ...
    return it("should handle book: 2Sam (fa)", function() {
  ...
  describe("Localized book 1Sam (fa)", function() {
    ...
    return it("should handle book: 1Sam (fa)", function() {
  ...
  describe("Localized book 2Kgs (fa)", function() {
    ...
    return it("should handle book: 2Kgs (fa)", function() {
  ...
  describe("Localized book 1Kgs (fa)", function() {
    ...
    return it("should handle book: 1Kgs (fa)", function() {
  ...
  describe("Localized book 2Chr (fa)", function() {
    ...
    return it("should handle book: 2Chr (fa)", function() {
  ...
  describe("Localized book 1Chr (fa)", function() {
    ...
    return it("should handle book: 1Chr (fa)", function() {
  ...
  describe("Localized book 1John (fa)", function() {
    ...
    return it("should handle book: 1John (fa)", function() {
  ...
  describe("Localized book 2John (fa)", function() {
    ...
    return it("should handle book: 2John (fa)", function() {
  ...
  describe("Localized book 3John (fa)", function() {
    ...
    return it("should handle book: 3John (fa)", function() {
  ...
  describe("Localized book 2Cor (fa)", function() {
    ...
    return it("should handle book: 2Cor (fa)", function() {
  ...
  describe("Localized book 1Cor (fa)", function() {
    ...
    return it("should handle book: 1Cor (fa)", function() {
  ...
  describe("Localized book Eph (fa)", function() {
    ...
    return it("should handle book: Eph (fa)", function() {
		...
		expect(p.parse("افسسسیان 1:1").osis()).toEqual("Eph.1.1")
  ...
  describe("Localized book 2Thess (fa)", function() {
    ...
    return it("should handle book: 2Thess (fa)", function() {
  ...
  describe("Localized book 1Thess (fa)", function() {
    ...
    return it("should handle book: 1Thess (fa)", function() {
  ...
  describe("Localized book 2Tim (fa)", function() {
    ...
    return it("should handle book: 2Tim (fa)", function() {
  ...
  describe("Localized book 1Tim (fa)", function() {
    ...
    return it("should handle book: 1Tim (fa)", function() {
  ...
  describe("Localized book 2Pet (fa)", function() {
    ...
    return it("should handle book: 2Pet (fa)", function() {
  ...
  describe("Localized book 1Pet (fa)", function() {
    ...
    return it("should handle book: 1Pet (fa)", function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle chapters (fa)", function() {
      ...
      expect(p.parse("Titus 1:1, بـاب 2").osis()).toEqual("Titus.1.1,Titus.2");
      expect(p.parse("Matt 3:4 بـاب 6").osis()).toEqual("Matt.3.4,Matt.6");
      expect(p.parse("Titus 1:1, بـاب 2").osis()).toEqual("Titus.1.1,Titus.2");
      expect(p.parse("Matt 3:4 بـاب 6").osis()).toEqual("Matt.3.4,Matt.6");
      expect(p.parse("Titus 1:1, باب 2").osis()).toEqual("Titus.1.1,Titus.2");
      return expect(p.parse("Matt 3:4 باب 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    it("should handle verses (fa)", function() {
      expect(p.parse("Exod 1:1 ایات 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      expect(p.parse("Phlm ایات 6").osis()).toEqual("Phlm.1.6");
      expect(p.parse("Exod 1:1 ایه 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      expect(p.parse("Phlm ایه 6").osis()).toEqual("Phlm.1.6");
