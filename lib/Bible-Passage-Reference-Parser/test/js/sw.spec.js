(function() {
  ...
  describe("Localized book 2Kgs (sw)", function() {
    ...
    return it("should handle book: 2Kgs (sw)", function() {
		...
		expect(p.parse("II Wafalme 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("Pili Falme 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("Wafalme II 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("2 Wafalme 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("II. Falme 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("2. Falme 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("II Falme 1:1").osis()).toEqual("2Kgs.1.1")
  ...
  describe("Localized book 1Kgs (sw)", function() {
    ...
    return it("should handle book: 1Kgs (sw)", function() {
		...
		expect(p.parse("Kwanza Falme 1:1").osis()).toEqual("1Kgs.1.1")
		...
		expect(p.parse("1. Falme 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("I. Falme 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("1 Falme 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("I Falme 1:1").osis()).toEqual("1Kgs.1.1")
  ...
  describe("Localized book 2Chr (sw)", function() {
    ...
    return it("should handle book: 2Chr (sw)", function() {
		...
		expect(p.parse("2 Mambo ya Nyakati 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("Pili Nyakati 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("II. Nyakati 1:1").osis()).toEqual("2Chr.1.1")
  ...
  describe("Localized book 1Chr (sw)", function() {
    ...
    return it("should handle book: 1Chr (sw)", function() {
		...
		expect(p.parse("Kwanza Nyakati 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1. Nyakati 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("I. Nyakati 1:1").osis()).toEqual("1Chr.1.1")
