(function() {
  ...
  describe("Localized book Gen (bn)", function() {
    ...
    return it("should handle book: Gen (bn)", function() {
  ...
  describe("Localized book Exod (bn)", function() {
    ...
    return it("should handle book: Exod (bn)", function() {
  ...
  describe("Localized book Bel (bn)", function() {
    ...
    return it("should handle book: Bel (bn)", function() {
  ...
  describe("Localized book Lev (bn)", function() {
    ...
    return it("should handle book: Lev (bn)", function() {
  ...
  describe("Localized book Num (bn)", function() {
    ...
    return it("should handle book: Num (bn)", function() {
  ...
  describe("Localized book Sir (bn)", function() {
    ...
    return it("should handle book: Sir (bn)", function() {
  ...
  describe("Localized book Wis (bn)", function() {
    ...
    return it("should handle book: Wis (bn)", function() {
  ...
  describe("Localized book Lam (bn)", function() {
    ...
    return it("should handle book: Lam (bn)", function() {
  ...
  describe("Localized book EpJer (bn)", function() {
    ...
    return it("should handle book: EpJer (bn)", function() {
  ...
  describe("Localized book Rev (bn)", function() {
    ...
    return it("should handle book: Rev (bn)", function() {
  ...
  describe("Localized book PrMan (bn)", function() {
    ...
    return it("should handle book: PrMan (bn)", function() {
  ...
  describe("Localized book Deut (bn)", function() {
    ...
    return it("should handle book: Deut (bn)", function() {
  ...
  describe("Localized book Josh (bn)", function() {
    ...
    return it("should handle book: Josh (bn)", function() {
  ...
  describe("Localized book Judg (bn)", function() {
    ...
    return it("should handle book: Judg (bn)", function() {
  ...
  describe("Localized book Ruth (bn)", function() {
    ...
    return it("should handle book: Ruth (bn)", function() {
  ...
  describe("Localized book 1Esd (bn)", function() {
    ...
    return it("should handle book: 1Esd (bn)", function() {
  ...
  describe("Localized book 2Esd (bn)", function() {
    ...
    return it("should handle book: 2Esd (bn)", function() {
  ...
  describe("Localized book Isa (bn)", function() {
    ...
    return it("should handle book: Isa (bn)", function() {
  ...
  describe("Localized book 2Sam (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Sam (bn)", function() {
      p.set_options({
  ...
  describe("Localized book 1Sam (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Sam (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Kgs (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Kgs (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Kgs (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Kgs (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Chr (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Chr (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Chr (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Chr (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Ezra (bn)", function() {
    ...
    return it("should handle book: Ezra (bn)", function() {
  ...
  describe("Localized book Neh (bn)", function() {
    ...
    return it("should handle book: Neh (bn)", function() {
  ...
  describe("Localized book GkEsth (bn)", function() {
    ...
    return it("should handle book: GkEsth (bn)", function() {
  ...
  describe("Localized book Esth (bn)", function() {
    ...
    return it("should handle book: Esth (bn)", function() {
  ...
  describe("Localized book Job (bn)", function() {
    ...
    return it("should handle book: Job (bn)", function() {
  ...
  describe("Localized book Ps (bn)", function() {
    ...
    return it("should handle book: Ps (bn)", function() {
  ...
  describe("Localized book PrAzar (bn)", function() {
    ...
    return it("should handle book: PrAzar (bn)", function() {
  ...
  describe("Localized book Prov (bn)", function() {
    ...
    return it("should handle book: Prov (bn)", function() {
  ...
  describe("Localized book Eccl (bn)", function() {
    ...
    return it("should handle book: Eccl (bn)", function() {
  ...
  describe("Localized book SgThree (bn)", function() {
    ...
    return it("should handle book: SgThree (bn)", function() {
  ...
  describe("Localized book Song (bn)", function() {
    ...
    return it("should handle book: Song (bn)", function() {
  ...
  describe("Localized book Jer (bn)", function() {
    ...
    return it("should handle book: Jer (bn)", function() {
  ...
  describe("Localized book Ezek (bn)", function() {
    ...
    return it("should handle book: Ezek (bn)", function() {
  ...
  describe("Localized book Dan (bn)", function() {
    ...
    return it("should handle book: Dan (bn)", function() {
  ...
  describe("Localized book Hos (bn)", function() {
    ...
    return it("should handle book: Hos (bn)", function() {
  ...
  describe("Localized book Joel (bn)", function() {
    ...
    return it("should handle book: Joel (bn)", function() {
  ...
  describe("Localized book Amos (bn)", function() {
    ...
    return it("should handle book: Amos (bn)", function() {
  ...
  describe("Localized book Obad (bn)", function() {
    ...
    return it("should handle book: Obad (bn)", function() {
  ...
  describe("Localized book Jonah (bn)", function() {
    ...
    return it("should handle book: Jonah (bn)", function() {
  ...
  describe("Localized book Mic (bn)", function() {
    ...
    return it("should handle book: Mic (bn)", function() {
  ...
  describe("Localized book Nah (bn)", function() {
    ...
    return it("should handle book: Nah (bn)", function() {
  ...
  describe("Localized book Hab (bn)", function() {
    ...
    return it("should handle book: Hab (bn)", function() {
  ...
  describe("Localized book Zeph (bn)", function() {
    ...
    return it("should handle book: Zeph (bn)", function() {
  ...
  describe("Localized book Hag (bn)", function() {
    ...
    return it("should handle book: Hag (bn)", function() {
  ...
  describe("Localized book Zech (bn)", function() {
    ...
    return it("should handle book: Zech (bn)", function() {
  ...
  describe("Localized book Mal (bn)", function() {
    ...
    return it("should handle book: Mal (bn)", function() {
  ...
  describe("Localized book Matt (bn)", function() {
    ...
    return it("should handle book: Matt (bn)", function() {
  ...
  describe("Localized book Mark (bn)", function() {
    ...
    return it("should handle book: Mark (bn)", function() {
  ...
  describe("Localized book Luke (bn)", function() {
    ...
    return it("should handle book: Luke (bn)", function() {
  ...
  describe("Localized book 1John (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1John (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2John (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2John (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 3John (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 3John (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book John (bn)", function() {
    ...
    return it("should handle book: John (bn)", function() {
  ...
  describe("Localized book Acts (bn)", function() {
    ...
    return it("should handle book: Acts (bn)", function() {
  ...
  describe("Localized book Rom (bn)", function() {
    ...
    return it("should handle book: Rom (bn)", function() {
  ...
  describe("Localized book 2Cor (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Cor (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Cor (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Cor (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Gal (bn)", function() {
    ...
    return it("should handle book: Gal (bn)", function() {
  ...
  describe("Localized book Eph (bn)", function() {
    ...
    return it("should handle book: Eph (bn)", function() {
  ...
  describe("Localized book Phil (bn)", function() {
    ...
    return it("should handle book: Phil (bn)", function() {
  ...
  describe("Localized book Col (bn)", function() {
    ...
    return it("should handle book: Col (bn)", function() {
  ...
  describe("Localized book 2Thess (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Thess (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Thess (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Thess (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Tim (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Tim (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Tim (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Tim (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Titus (bn)", function() {
    ...
    return it("should handle book: Titus (bn)", function() {
  ...
  describe("Localized book Phlm (bn)", function() {
    ...
    return it("should handle book: Phlm (bn)", function() {
  ...
  describe("Localized book Heb (bn)", function() {
    ...
    return it("should handle book: Heb (bn)", function() {
  ...
  describe("Localized book Jas (bn)", function() {
    ...
    return it("should handle book: Jas (bn)", function() {
  ...
  describe("Localized book 2Pet (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Pet (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Pet (bn)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Pet (bn)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Jude (bn)", function() {
    ...
    return it("should handle book: Jude (bn)", function() {
  ...
  describe("Localized book Tob (bn)", function() {
    ...
    return it("should handle book: Tob (bn)", function() {
  ...
  describe("Localized book Jdt (bn)", function() {
    ...
    return it("should handle book: Jdt (bn)", function() {
  ...
  describe("Localized book Bar (bn)", function() {
    ...
    return it("should handle book: Bar (bn)", function() {
  ...
  describe("Localized book Sus (bn)", function() {
    ...
    return it("should handle book: Sus (bn)", function() {
  ...
  describe("Localized book 2Macc (bn)", function() {
    ...
    return it("should handle book: 2Macc (bn)", function() {
  ...
  describe("Localized book 3Macc (bn)", function() {
    ...
    return it("should handle book: 3Macc (bn)", function() {
  ...
  describe("Localized book 4Macc (bn)", function() {
    ...
    return it("should handle book: 4Macc (bn)", function() {
  ...
  describe("Localized book 1Macc (bn)", function() {
    ...
    return it("should handle book: 1Macc (bn)", function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should return the expected language", function() {
      return expect(p.languages).toEqual(["bn"]);
    });
    it("should handle ranges (bn)", function() {
      ...
      return expect(p.parse("Phlm 2 থেকে 3").osis()).toEqual("Phlm.1.2-Phlm.1.3");
    });
    ...
    it("should handle verses (bn)", function() {
      ...
      return expect(p.parse("Phlm আয়াত 6").osis()).toEqual("Phlm.1.6");
    });
    it("should handle 'and' (bn)", function() {
      expect(p.parse("Exod 1:1 এবং 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      return expect(p.parse("Phlm 2 এবং 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });
    ...
    it("should handle translations (bn)", function() {
      ...
      return expect(p.parse("lev 1 bn").osis_and_translations()).toEqual([["Lev.1", "bn"]]);
    });
