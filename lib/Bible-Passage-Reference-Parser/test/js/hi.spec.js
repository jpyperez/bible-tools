(function() {
  ...
  describe("Localized book Gen (hi)", function() {
    ...
    it("should handle book: Gen (hi)", function() {
      
		expect(p.parse("उत्त्पत्ति 1:1").osis()).toEqual("Gen.1.1")
    ...
    return it("should handle non-Latin digits in book: Gen (hi)", function() {
      p.set_options({
  ...
  describe("Localized book Exod (hi)", function() {
    ...
    it("should handle book: Exod (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Exod (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Lev (hi)", function() {
    ...
    it("should handle book: Lev (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Lev (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Rev (hi)", function() {
    ...
    it("should handle book: Rev (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Rev (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Deut (hi)", function() {
    ...
    it("should handle book: Deut (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Deut (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Isa (hi)", function() {
    ...
    it("should handle book: Isa (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Isa (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Ps (hi)", function() {
    ...
    it("should handle book: Ps (hi)", function() {
		...
		expect(p.parse("भजन सं0 1:1").osis()).toEqual("Ps.1.1")
		expect(p.parse("भजन सं० 1:1").osis()).toEqual("Ps.1.1")
    ...
    return it("should handle non-Latin digits in book: Ps (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Prov (hi)", function() {
    ...
    it("should handle book: Prov (hi)", function() {
      
		expect(p.parse("Neetivachan 1:1").osis()).toEqual("Prov.1.1")
		expect(p.parse("नीति वचन 1:1").osis()).toEqual("Prov.1.1")
		expect(p.parse("नीति व0 1:1").osis()).toEqual("Prov.1.1")
		expect(p.parse("नीति व० 1:1").osis()).toEqual("Prov.1.1")
    ...
    return it("should handle non-Latin digits in book: Prov (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Eccl (hi)", function() {
    ...
    it("should handle book: Eccl (hi)", function() {
		...
		expect(p.parse("सभोपo 1:1").osis()).toEqual("Eccl.1.1")
    ...
    return it("should handle non-Latin digits in book: Eccl (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Jer (hi)", function() {
    ...
    it("should handle book: Jer (hi)", function() {
      
		expect(p.parse("Yirmayah 1:1").osis()).toEqual("Jer.1.1")
		expect(p.parse("यिर्मयाह 1:1").osis()).toEqual("Jer.1.1")
		expect(p.parse("यिर्म0 1:1").osis()).toEqual("Jer.1.1")
		expect(p.parse("यिर्म० 1:1").osis()).toEqual("Jer.1.1")
		expect(p.parse("यिर्म 1:1").osis()).toEqual("Jer.1.1")
		expect(p.parse("Jer 1:1").osis()).toEqual("Jer.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: Jer (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Ezek (hi)", function() {
    ...
    it("should handle book: Ezek (hi)", function() {
      
		expect(p.parse("Yahejakel 1:1").osis()).toEqual("Ezek.1.1")
		expect(p.parse("यहेजकेल 1:1").osis()).toEqual("Ezek.1.1")
		expect(p.parse("यहेज0 1:1").osis()).toEqual("Ezek.1.1")
		expect(p.parse("यहेज० 1:1").osis()).toEqual("Ezek.1.1")
		expect(p.parse("Ezek 1:1").osis()).toEqual("Ezek.1.1")
		expect(p.parse("यहेज 1:1").osis()).toEqual("Ezek.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: Ezek (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Dan (hi)", function() {
    ...
    it("should handle book: Dan (hi)", function() {
		...
		expect(p.parse("दानियेल 1:1").osis()).toEqual("Dan.1.1")
    ...
    return it("should handle non-Latin digits in book: Dan (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Acts (hi)", function() {
    ...
    it("should handle book: Acts (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Acts (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Rom (hi)", function() {
    ...
    it("should handle book: Rom (hi)", function() {
		...
		expect(p.parse("रोमन 1:1").osis()).toEqual("Rom.1.1")
    ...
    return it("should handle non-Latin digits in book: Rom (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Cor (hi)", function() {
    ...
    it("should handle book: 2Cor (hi)", function() {
		...
		expect(p.parse("2 कुरिन्थ 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2. कुरिं0 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2. कुरिं० 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2 कुरिं0 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2 कुरिं० 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2. कुरि0 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2. कुरि० 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2 कुरि0 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2 कुरि० 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2कुरिं0 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2कुरिं० 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2Cor 1:1").osis()).toEqual("2Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Cor (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Cor (hi)", function() {
    ...
    it("should handle book: 1Cor (hi)", function() {
		...
		expect(p.parse("1 कुरिन्थ 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1. कुरिं0 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1. कुरिं० 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1 कुरिं0 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1 कुरिं० 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1. कुरि0 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1. कुरि० 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1 कुरि0 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1 कुरि० 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1कुरिं0 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1कुरिं० 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1Cor 1:1").osis()).toEqual("1Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Cor (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Eph (hi)", function() {
    ...
    it("should handle book: Eph (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Eph (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Phil (hi)", function() {
    ...
    it("should handle book: Phil (hi)", function() {
    ...
    return it("should handle non-Latin digits in book: Phil (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Thess (hi)", function() {
    ...
    it("should handle book: 2Thess (hi)", function() {
		...
		expect(p.parse("2 थिसलुनिकी 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2. थिस्सलु 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2 थिस्सलु 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2. थिस्स0 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2. थिस्स० 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2 थिस्स0 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2 थिस्स० 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2. थिस्स 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2थिस्सलु 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2 थिस्स 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2Thess 1:1").osis()).toEqual("2Thess.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Thess (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Thess (hi)", function() {
    ...
    it("should handle book: 1Thess (hi)", function() {
		...
		expect(p.parse("1 थिसलुनिकी 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. थिस्सलु 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1 थिस्सलु 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. थिस्स0 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. थिस्स० 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1 थिस्स0 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1 थिस्स० 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. थिस्स 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1थिस्सलु 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1 थिस्स 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1Thess 1:1").osis()).toEqual("1Thess.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Thess (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Tim (hi)", function() {
    ...
    it("should handle book: 2Tim (hi)", function() {
		...
		expect(p.parse("2 तिमुथियुस 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2 तीमुथियुस 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2. तीमु0 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2. तीमु० 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2 तीमु0 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2 तीमु० 1:1").osis()).toEqual("2Tim.1.1")
    ...
    return it("should handle non-Latin digits in book: 2Tim (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Tim (hi)", function() {
    ...
    it("should handle book: 1Tim (hi)", function() {
		...
		expect(p.parse("1 तिमुथियुस 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1 तीमुथियुस 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1. तीमु0 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1. तीमु० 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1 तीमु0 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1 तीमु० 1:1").osis()).toEqual("1Tim.1.1")
    ...
    return it("should handle non-Latin digits in book: 1Tim (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Pet (hi)", function() {
    ...
    it("should handle book: 2Pet (hi)", function() {
		...
		expect(p.parse("2 पतरस 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2. पत0 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2. पतर 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2. पत० 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 पत0 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 पतर 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 पत० 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2Pet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2पत0 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2पत० 1:1").osis()).toEqual("2Pet.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Pet (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Pet (hi)", function() {
    ...
    it("should handle book: 1Pet (hi)", function() {
		...
		expect(p.parse("1 पतरस 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1. पत0 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1. पतर 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1. पत० 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 पत0 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 पतर 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 पत० 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1Pet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1पत0 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1पत० 1:1").osis()).toEqual("1Pet.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Pet (hi)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
