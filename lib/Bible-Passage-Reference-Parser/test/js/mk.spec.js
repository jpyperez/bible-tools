(function() {
  ...
  describe("Localized book 2Sam (mk)", function() {
    ...
    return it("should handle book: 2Sam (mk)", function() {
		...
		expect(p.parse("Втора книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Второ книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Второ книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2.. книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2.. книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("II. книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("II. книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2. книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2. книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("II книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("II книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2 книга Самоилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2 книга Самуилова 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Втора Самоил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Втора Самуил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Второ Самоил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("Второ Самуил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2.. Самоил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2.. Самуил 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("II. Самоил 1:1").osis()).toEqual("2Sam.1.1")
  ...
  describe("Localized book 1Sam (mk)", function() {
    ...
    return it("should handle book: 1Sam (mk)", function() {
		...
		expect(p.parse("Прва книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прво книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прво книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1.. книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1.. книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1. книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1. книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("I. книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("I. книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1 книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1 книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("I книга Самоилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("I книга Самуилова 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прва Самоил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прва Самуил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прво Самоил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("Прво Самуил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1.. Самоил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1.. Самуил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1. Самоил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1. Самуил 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("I. Самоил 1:1").osis()).toEqual("1Sam.1.1")
  ...
  describe("Localized book 2Thess (mk)", function() {
    ...
    return it("should handle book: 2Thess (mk)", function() {
		...
		expect(p.parse("Втора Солуњаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("Второ Солуњаните 1:1").osis()).toEqual("2Thess.1.1")
		...
		expect(p.parse("2. Солунјаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2.. Солуњаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("II Солунјаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("II. Солуњаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2 Солунјаните 1:1").osis()).toEqual("2Thess.1.1")
		expect(p.parse("2. Солуњаните 1:1").osis()).toEqual("2Thess.1.1")
  ...
  describe("Localized book 1Thess (mk)", function() {
    ...
    return it("should handle book: 1Thess (mk)", function() {
		...
		expect(p.parse("Прва Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("Прво Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. Солунјаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1.. Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
		...
		expect(p.parse("I Солунјаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("I. Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1 Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. Солунците 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("1. Солунјани 1:1").osis()).toEqual("1Thess.1.1")
		expect(p.parse("I Солуњаните 1:1").osis()).toEqual("1Thess.1.1")
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle chapters (mk)", function() {
      ...
      return expect(p.parse("Matt 3:4 ГЛАВА 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    ...
    it("should handle book ranges (mk)", function() {
      ...
      return expect(p.parse("Прва - Трета  Јован").osis()).toEqual("1John.1-3John.1");
    });
