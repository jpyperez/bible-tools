(function() {
  ...
  describe("Localized book Gen (si)", function() {
    ...
    return it("should handle book: Gen (si)", function() {
  ...
  describe("Localized book Exod (si)", function() {
    ...
    return it("should handle book: Exod (si)", function() {
  ...
  describe("Localized book Bel (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Bel (si)", function() {
  ...
  describe("Localized book Lev (si)", function() {
    ...
    return it("should handle book: Lev (si)", function() {
  ...
  describe("Localized book Num (si)", function() {
    ...
    return it("should handle book: Num (si)", function() {
  ...
  describe("Localized book Sir (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Sir (si)", function() {
  ...
  describe("Localized book Wis (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Wis (si)", function() {
  ...
  describe("Localized book Lam (si)", function() {
    ...
    return it("should handle book: Lam (si)", function() {
  ...
  describe("Localized book EpJer (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: EpJer (si)", function() {
  ...
  describe("Localized book Rev (si)", function() {
    ...
    return it("should handle book: Rev (si)", function() {
  ...
  describe("Localized book PrMan (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: PrMan (si)", function() {
  ...
  describe("Localized book Deut (si)", function() {
    ...
    return it("should handle book: Deut (si)", function() {
  ...
  describe("Localized book Josh (si)", function() {
    ...
    return it("should handle book: Josh (si)", function() {
  ...
  describe("Localized book Judg (si)", function() {
    ...
    return it("should handle book: Judg (si)", function() {
  ...
  describe("Localized book Ruth (si)", function() {
    ...
    return it("should handle book: Ruth (si)", function() {
  ...
  describe("Localized book 1Esd (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 1Esd (si)", function() {
  ...
  describe("Localized book 2Esd (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 2Esd (si)", function() {
  ...
  describe("Localized book Isa (si)", function() {
    ...
    return it("should handle book: Isa (si)", function() {
  ...
  describe("Localized book 2Sam (si)", function() {
    ...
    return it("should handle book: 2Sam (si)", function() {
  ...
  describe("Localized book 1Sam (si)", function() {
    ...
    return it("should handle book: 1Sam (si)", function() {
  ...
  describe("Localized book 2Kgs (si)", function() {
    ...
    return it("should handle book: 2Kgs (si)", function() {
  ...
  describe("Localized book 1Kgs (si)", function() {
    ...
    return it("should handle book: 1Kgs (si)", function() {
  ...
  describe("Localized book 2Chr (si)", function() {
    ...
    return it("should handle book: 2Chr (si)", function() {
  ...
  describe("Localized book 1Chr (si)", function() {
    ...
    return it("should handle book: 1Chr (si)", function() {
  ...
  describe("Localized book Ezra (si)", function() {
    ...
    return it("should handle book: Ezra (si)", function() {
  ...
  describe("Localized book Neh (si)", function() {
    ...
    return it("should handle book: Neh (si)", function() {
  ...
  describe("Localized book GkEsth (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: GkEsth (si)", function() {
  ...
  describe("Localized book Esth (si)", function() {
    ...
    return it("should handle book: Esth (si)", function() {
  ...
  describe("Localized book Job (si)", function() {
    ...
    return it("should handle book: Job (si)", function() {
  ...
  describe("Localized book Ps (si)", function() {
    ...
    return it("should handle book: Ps (si)", function() {
  ...
  describe("Localized book PrAzar (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: PrAzar (si)", function() {
  ...
  describe("Localized book Prov (si)", function() {
    ...
    return it("should handle book: Prov (si)", function() {
  ...
  describe("Localized book Eccl (si)", function() {
    ...
    return it("should handle book: Eccl (si)", function() {
  ...
  describe("Localized book SgThree (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: SgThree (si)", function() {
  ...
  describe("Localized book Song (si)", function() {
    ...
    return it("should handle book: Song (si)", function() {
  ...
  describe("Localized book Jer (si)", function() {
    ...
    return it("should handle book: Jer (si)", function() {
  ...
  describe("Localized book Ezek (si)", function() {
    ...
    return it("should handle book: Ezek (si)", function() {
  ...
  describe("Localized book Dan (si)", function() {
    ...
    return it("should handle book: Dan (si)", function() {
  ...
  describe("Localized book Hos (si)", function() {
    ...
    return it("should handle book: Hos (si)", function() {
  ...
  describe("Localized book Joel (si)", function() {
    ...
    return it("should handle book: Joel (si)", function() {
  ...
  describe("Localized book Amos (si)", function() {
    ...
    return it("should handle book: Amos (si)", function() {
  ...
  describe("Localized book Obad (si)", function() {
    ...
    return it("should handle book: Obad (si)", function() {
  ...
  describe("Localized book Jonah (si)", function() {
    ...
    return it("should handle book: Jonah (si)", function() {
  ...
  describe("Localized book Mic (si)", function() {
    ...
    return it("should handle book: Mic (si)", function() {
  ...
  describe("Localized book Nah (si)", function() {
    ...
    return it("should handle book: Nah (si)", function() {
  ...
  describe("Localized book Hab (si)", function() {
    ...
    return it("should handle book: Hab (si)", function() {
  ...
  describe("Localized book Zeph (si)", function() {
    ...
    return it("should handle book: Zeph (si)", function() {
  ...
  describe("Localized book Hag (si)", function() {
    ...
    return it("should handle book: Hag (si)", function() {
  ...
  describe("Localized book Zech (si)", function() {
    ...
    return it("should handle book: Zech (si)", function() {
  ...
  describe("Localized book Mal (si)", function() {
    ...
    return it("should handle book: Mal (si)", function() {
  ...
  describe("Localized book Matt (si)", function() {
    ...
    return it("should handle book: Matt (si)", function() {
  ...
  describe("Localized book Mark (si)", function() {
    ...
    return it("should handle book: Mark (si)", function() {
  ...
  describe("Localized book Luke (si)", function() {
    ...
    return it("should handle book: Luke (si)", function() {
  ...
  describe("Localized book 1John (si)", function() {
    ...
    return it("should handle book: 1John (si)", function() {
  ...
  describe("Localized book 2John (si)", function() {
    ...
    return it("should handle book: 2John (si)", function() {
  ...
  describe("Localized book 3John (si)", function() {
    ...
    return it("should handle book: 3John (si)", function() {
  ...
  describe("Localized book John (si)", function() {
    ...
    return it("should handle book: John (si)", function() {
  ...
  describe("Localized book Acts (si)", function() {
    ...
    return it("should handle book: Acts (si)", function() {
  ...
  describe("Localized book Rom (si)", function() {
    ...
    return it("should handle book: Rom (si)", function() {
  ...
  describe("Localized book 2Cor (si)", function() {
    ...
    return it("should handle book: 2Cor (si)", function() {
  ...
  describe("Localized book 1Cor (si)", function() {
    ...
    return it("should handle book: 1Cor (si)", function() {
  ...
  describe("Localized book Gal (si)", function() {
    ...
    return it("should handle book: Gal (si)", function() {
  ...
  describe("Localized book Eph (si)", function() {
    ...
    return it("should handle book: Eph (si)", function() {
  ...
  describe("Localized book Phil (si)", function() {
    ...
    return it("should handle book: Phil (si)", function() {
  ...
  describe("Localized book Col (si)", function() {
    ...
    return it("should handle book: Col (si)", function() {
  ...
  describe("Localized book 2Thess (si)", function() {
    ...
    return it("should handle book: 2Thess (si)", function() {
  ...
  describe("Localized book 1Thess (si)", function() {
    ...
    return it("should handle book: 1Thess (si)", function() {
  ...
  describe("Localized book 2Tim (si)", function() {
    ...
    return it("should handle book: 2Tim (si)", function() {
  ...
  describe("Localized book 1Tim (si)", function() {
    ...
    return it("should handle book: 1Tim (si)", function() {
  ...
  describe("Localized book Titus (si)", function() {
    ...
    return it("should handle book: Titus (si)", function() {
  ...
  describe("Localized book Phlm (si)", function() {
    ...
    return it("should handle book: Phlm (si)", function() {
  ...
  describe("Localized book Heb (si)", function() {
    ...
    return it("should handle book: Heb (si)", function() {
  ...
  describe("Localized book Jas (si)", function() {
    ...
    return it("should handle book: Jas (si)", function() {
  ...
  describe("Localized book 2Pet (si)", function() {
    ...
    return it("should handle book: 2Pet (si)", function() {
  ...
  describe("Localized book 1Pet (si)", function() {
    ...
    return it("should handle book: 1Pet (si)", function() {
  ...
  describe("Localized book Jude (si)", function() {
    ...
    return it("should handle book: Jude (si)", function() {
  ...
  describe("Localized book Tob (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Tob (si)", function() {
  ...
  describe("Localized book Jdt (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Jdt (si)", function() {
  ...
  describe("Localized book Bar (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Bar (si)", function() {
  ...
  describe("Localized book Sus (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: Sus (si)", function() {
  ...
  describe("Localized book 2Macc (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 2Macc (si)", function() {
  ...
  describe("Localized book 3Macc (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 3Macc (si)", function() {
  ...
  describe("Localized book 4Macc (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 4Macc (si)", function() {
  ...
  describe("Localized book 1Macc (si)", function() {
    var p;
    p = {};
    beforeEach(function() {
      p = new bcv_parser;
    ...
    return it("should handle book: 1Macc (si)", function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should return the expected language", function() {
      return expect(p.languages).toEqual(["si"]);
    });
    ...
    it("should handle chapters (si)", function() {
      ...
      return expect(p.parse("Matt 3:4 පරිච්ඡේදය 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    it("should handle verses (si)", function() {
      expect(p.parse("Exod 1:1 පදය 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      return expect(p.parse("Phlm පදය 6").osis()).toEqual("Phlm.1.6");
    });
    it("should handle 'and' (si)", function() {
      expect(p.parse("Exod 1:1 සහ 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      return expect(p.parse("Phlm 2 සහ 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });
    ...
    it("should handle translations (si)", function() {
      ...
      return expect(p.parse("lev 1 srov").osis_and_translations()).toEqual([["Lev.1", "srov"]]);
    });
