(function() {
  ...
  describe("Localized book 2Kgs (hr)", function() {
    ...
    return it("should handle book: 2Kgs (hr)", function() {
		...
		expect(p.parse("Druga O Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("Druga Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("II. O Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("2. O Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("II O Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("2 O Kraljevima 1:1").osis()).toEqual("2Kgs.1.1")
  ...
  describe("Localized book 1Kgs (hr)", function() {
    ...
    return it("should handle book: 1Kgs (hr)", function() {
		...
		expect(p.parse("Prva O Kraljevima 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("1. O Kraljevima 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("I. O Kraljevima 1:1").osis()).toEqual("1Kgs.1.1")
  ...
  describe("Localized book Acts (hr)", function() {
    ...
    return it("should handle book: Acts (hr)", function() {
		...
		expect(p.parse("Djela 1:1").osis()).toEqual("Acts.1.1")
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle chapters (hr)", function() {
      ...
      return expect(p.parse("Matt 3:4 GLAVA 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    ...
    it("should handle book ranges (hr)", function() {
      ...
      return expect(p.parse("Prva - Treæa  Ivanova").osis()).toEqual("1John.1-3John.1");
    });
