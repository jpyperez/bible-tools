(function() {
  ...
  describe("Localized book Deut (or)", function() {
    ...
    return it("should handle book: Deut (or)", function() {
		...
		expect(p.parse("ଦ୍ୱି.ବିବ 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("ଦ୍ୱିବିବ 1:1").osis()).toEqual("Deut.1.1")
  ...
  describe("Localized book Isa (or)", function() {
    ...
    return it("should handle book: Isa (or)", function() {
		...
		expect(p.parse("ଯିଶାୟ 1:1").osis()).toEqual("Isa.1.1")
  ...
  describe("Localized book 2Chr (or)", function() {
    ...
    return it("should handle book: 2Chr (or)", function() {
		...
		expect(p.parse("2 ବଂଶାବଳୀ 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 ଵଂଶାଵଲୀ 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2ଵଂଶାଵଲୀ 1:1").osis()).toEqual("2Chr.1.1")
  ...
  describe("Localized book 1Chr (or)", function() {
    ...
    it("should handle book: 1Chr (or)", function() {
		...
		expect(p.parse("1 ବଂଶାବଳୀ 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 ଵଂଶାଵଲୀ 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1ଵଂଶାଵଲୀ 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 ବଂଶା 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("୧ ବଂଶା 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1Chr 1:1").osis()).toEqual("1Chr.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Chr (or)", function() {
      p.set_options({
  ...
  describe("Localized book Jer (or)", function() {
    ...
    return it("should handle book: Jer (or)", function() {
		...
		expect(p.parse("ଯିରୀ 1:1").osis()).toEqual("Jer.1.1")
  ...
  describe("Localized book Dan (or)", function() {
    ...
    return it("should handle book: Dan (or)", function() {
		...
		expect(p.parse("ଦାନିଏଲ 1:1").osis()).toEqual("Dan.1.1")
  ...
  describe("Localized book Hag (or)", function() {
    ...
    return it("should handle book: Hag (or)", function() {
		...
		expect(p.parse("ହାଗାୟ 1:1").osis()).toEqual("Hag.1.1")
  ...
  describe("Localized book Matt (or)", function() {
    ...
    return it("should handle book: Matt (or)", function() {
		...
		expect(p.parse("ମାଥିଓ 1:1").osis()).toEqual("Matt.1.1")
  ...
  describe("Localized book 1John (or)", function() {
    ...
    it("should handle book: 1John (or)", function() {
    ...
    return it("should handle non-Latin digits in book: 1John (or)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Cor (or)", function() {
    ...
    return it("should handle book: 2Cor (or)", function() {
		...
		expect(p.parse("2କରି 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2କର 1:1").osis()).toEqual("2Cor.1.1")
		p.include_apocrypha(false)
		expect(p.parse("କରିନ୍ଥୀୟଙ୍କ ପ୍ରତି ଦ୍ୱିତୀୟ ପତ୍ର 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("ଦ୍ୱିତୀୟ କରିନ୍ଥୀୟଙ୍କ 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("ଦ୍ୱିତୀୟ କରିନ୍ଥୀୟ 1:1").osis()).toEqual("2Cor.1.1")
  ...
  describe("Localized book 1Cor (or)", function() {
    ...
    it("should handle book: 1Cor (or)", function() {
		...
		expect(p.parse("1 କରିନ୍ଥୀୟ 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1କରନ୍ଥୀୟ 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("୧କରନ୍ଥୀୟ 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1Cor 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1କରି 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1କର 1:1").osis()).toEqual("1Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Cor (or)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Eph (or)", function() {
    ...
    return it("should handle book: Eph (or)", function() {
		...
		expect(p.parse("ଏଫିସ 1:1").osis()).toEqual("Eph.1.1")
  ...
  describe("Localized book Col (or)", function() {
    ...
    return it("should handle book: Col (or)", function() {
		...
		expect(p.parse("କଲସିଓ 1:1").osis()).toEqual("Col.1.1")
  ...
  describe("Localized book 2Pet (or)", function() {
    ...
    return it("should handle book: 2Pet (or)", function() {
		...
		expect(p.parse("2 ପିତରଙ 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("1 ପିତର 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2ପିତର 1:1").osis()).toEqual("2Pet.1.1")
  ...
  describe("Localized book 1Pet (or)", function() {
    ...
    return it("should handle book: 1Pet (or)", function() {
		...
		expect(p.parse("1ପିତର 1:1").osis()).toEqual("1Pet.1.1")
