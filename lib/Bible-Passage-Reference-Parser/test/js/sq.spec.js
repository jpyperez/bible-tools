(function() {
  ...
  describe("Localized book Rev (sq)", function() {
    ...
    return it("should handle book: Rev (sq)", function() {
		...
		expect(p.parse("Zbul 1:1").osis()).toEqual("Rev.1.1")
  ...
  describe("Localized book Deut (sq)", function() {
    ...
    return it("should handle book: Deut (sq)", function() {
		...
		expect(p.parse("Ligji i përtërirë 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj. Pert. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj. Përt. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj Pert. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj Përt. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj. Pert 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj. Përt 1:1").osis()).toEqual("Deut.1.1")
		...
		expect(p.parse("Lgj.Pert 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("Lgj.Përt 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("LgjPert. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("LgjPërt. 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("LgjPert 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("LgjPërt 1:1").osis()).toEqual("Deut.1.1")
  ...
  describe("Localized book 2Chr (sq)", function() {
    ...
    return it("should handle book: 2Chr (sq)", function() {
		...
		expect(p.parse("2 Kronika 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 e. Kron 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 i. Kron 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 e Kron 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 i Kron 1:1").osis()).toEqual("2Chr.1.1")
  ...
  describe("Localized book 1Chr (sq)", function() {
    ...
    return it("should handle book: 1Chr (sq)", function() {
		...
		expect(p.parse("1 Kronika 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 e. Kron 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 i. Kron 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 e Kron 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 i Kron 1:1").osis()).toEqual("1Chr.1.1")
  ...
  describe("Localized book Ps (sq)", function() {
    ...
    return it("should handle book: Ps (sq)", function() {
		...
		expect(p.parse("Psalmin 1:1").osis()).toEqual("Ps.1.1")
  ...
  describe("Localized book John (sq)", function() {
    ...
    return it("should handle book: John (sq)", function() {
		...
		expect(p.parse("Gjonin 1:1").osis()).toEqual("John.1.1")
  ...
  describe("Localized book Rom (sq)", function() {
    ...
    return it("should handle book: Rom (sq)", function() {
		...
		expect(p.parse("Romaket 1:1").osis()).toEqual("Rom.1.1")
		expect(p.parse("Romakët 1:1").osis()).toEqual("Rom.1.1")
  ...
  describe("Localized book Col (sq)", function() {
    ...
    return it("should handle book: Col (sq)", function() {
		...
		expect(p.parse("Kolosianet 1:1").osis()).toEqual("Col.1.1")
		expect(p.parse("Kolosianët 1:1").osis()).toEqual("Col.1.1")
  ...
  describe("Localized book Heb (sq)", function() {
    ...
    return it("should handle book: Heb (sq)", function() {
		...
		expect(p.parse("Hebrenjte 1:1").osis()).toEqual("Heb.1.1")
		expect(p.parse("Hebrenjtë 1:1").osis()).toEqual("Heb.1.1")
  ...
  describe("Localized book 2Pet (sq)", function() {
    ...
    return it("should handle book: 2Pet (sq)", function() {
		...
		expect(p.parse("2 Pjetrit 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 e. Pjet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 i. Pjet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 e Pjet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 i Pjet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2. Pjet 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("2 Pjet 1:1").osis()).toEqual("2Pet.1.1")
  ...
  describe("Localized book 1Pet (sq)", function() {
    ...
    return it("should handle book: 1Pet (sq)", function() {
		...
		expect(p.parse("1 Pjetrit 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 e. Pjet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 i. Pjet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 e Pjet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 i Pjet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1. Pjet 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 Pjet 1:1").osis()).toEqual("1Pet.1.1")
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle 'and' (sq)", function() {
      ...
      expect(p.parse("Exod 1:1 dhe 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      return expect(p.parse("Phlm 2 DHE 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });
