(function() {
  ...
  describe("Localized book Num (mr)", function() {
    ...
    return it("should handle book: Num (mr)", function() {
		...
		expect(p.parse("गण 1:1").osis()).toEqual("Num.1.1")
		p.include_apocrypha(false)
		expect(p.parse("GANANA 1:1").osis()).toEqual("Num.1.1")
		expect(p.parse("GANANĀ 1:1").osis()).toEqual("Num.1.1")
		expect(p.parse("GAṆANA 1:1").osis()).toEqual("Num.1.1")
  ...
  describe("Localized book Rev (mr)", function() {
    ...
    return it("should handle book: Rev (mr)", function() {
		...
		expect(p.parse("प्रकटी 1:1").osis()).toEqual("Rev.1.1")
  ...
  describe("Localized book Deut (mr)", function() {
    ...
    return it("should handle book: Deut (mr)", function() {
		...
		expect(p.parse("अनु 1:1").osis()).toEqual("Deut.1.1")
		p.include_apocrypha(false)
		expect(p.parse("ANUWAD 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("ANUWĀD 1:1").osis()).toEqual("Deut.1.1")
		expect(p.parse("अनुवाद 1:1").osis()).toEqual("Deut.1.1")
  ...
  describe("Localized book 2Sam (mr)", function() {
    ...
    it("should handle book: 2Sam (mr)", function() {
		...
		expect(p.parse("२ शमुवेल 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2 शमु 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("२ शमु 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2Sam 1:1").osis()).toEqual("2Sam.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Sam (mr)", function() {
      p.set_options({
  ...
  describe("Localized book 1Sam (mr)", function() {
    ...
    it("should handle book: 1Sam (mr)", function() {
		...
		expect(p.parse("१ शमुवेल 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1 शमु 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("१ शमु 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1Sam 1:1").osis()).toEqual("1Sam.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Sam (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Kgs (mr)", function() {
    ...
    it("should handle book: 2Kgs (mr)", function() {
		...
		expect(p.parse("२ राजे 1:1").osis()).toEqual("2Kgs.1.1")
		expect(p.parse("2Kgs 1:1").osis()).toEqual("2Kgs.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Kgs (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Kgs (mr)", function() {
    ...
    it("should handle book: 1Kgs (mr)", function() {
		...
		expect(p.parse("१ राजे 1:1").osis()).toEqual("1Kgs.1.1")
		expect(p.parse("1Kgs 1:1").osis()).toEqual("1Kgs.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Kgs (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 2Chr (mr)", function() {
    ...
    it("should handle book: 2Chr (mr)", function() {
    ...
    return it("should handle non-Latin digits in book: 2Chr (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Chr (mr)", function() {
    ...
    it("should handle book: 1Chr (mr)", function() {
    ...
    return it("should handle non-Latin digits in book: 1Chr (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Song (mr)", function() {
    ...
    return it("should handle book: Song (mr)", function() {
		...
		expect(p.parse("गीत 1:1").osis()).toEqual("Song.1.1")
		p.include_apocrypha(false)
		expect(p.parse("GITRATNA 1:1").osis()).toEqual("Song.1.1")
		expect(p.parse("GĪTRATNA 1:1").osis()).toEqual("Song.1.1")
		expect(p.parse("गीतरत्न 1:1").osis()).toEqual("Song.1.1")
  ...
  describe("Localized book Dan (mr)", function() {
    ...
    return it("should handle book: Dan (mr)", function() {
		...
		expect(p.parse("दानी 1:1").osis()).toEqual("Dan.1.1")
  ...
  describe("Localized book Zech (mr)", function() {
    ...
    return it("should handle book: Zech (mr)", function() {
		...
		expect(p.parse("जखर्‍या 1:1").osis()).toEqual("Zech.1.1")
  ...
  describe("Localized book Acts (mr)", function() {
    ...
    return it("should handle book: Acts (mr)", function() {
		...
		expect(p.parse("प्रेषितांची कृत्ये 1:1").osis()).toEqual("Acts.1.1")
  ...
  describe("Localized book 2Cor (mr)", function() {
    ...
    it("should handle book: 2Cor (mr)", function() {
		...
		expect(p.parse("2 करिंथ 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("२ करिंथ 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2Cor 1:1").osis()).toEqual("2Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Cor (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Cor (mr)", function() {
    ...
    it("should handle book: 1Cor (mr)", function() {
		...
		expect(p.parse("१ करिंथ 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1Cor 1:1").osis()).toEqual("1Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Cor (mr)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Eph (mr)", function() {
    ...
    return it("should handle book: Eph (mr)", function() {
		...
		expect(p.parse("इफिस 1:1").osis()).toEqual("Eph.1.1")
  ...
  describe("Localized book Phil (mr)", function() {
    ...
    return it("should handle book: Phil (mr)", function() {
		...
		expect(p.parse("फिलिप्पै 1:1").osis()).toEqual("Phil.1.1")
  ...
  describe("Localized book Col (mr)", function() {
    ...
    return it("should handle book: Col (mr)", function() {
		...
		expect(p.parse("कलस्सैकरांना पत्र 1:1").osis()).toEqual("Col.1.1")
		...
		expect(p.parse("कलस्सै 1:1").osis()).toEqual("Col.1.1")
  ...
  describe("Localized book 2Thess (mr)", function() {
    ...
    return it("should handle book: 2Thess (mr)", function() {
		...
		expect(p.parse("2 थेस्सल 1:1").osis()).toEqual("2Thess.1.1")
  ...
  describe("Localized book 1Thess (mr)", function() {
    ...
    return it("should handle book: 1Thess (mr)", function() {
		...
		expect(p.parse("1 थेस्सल 1:1").osis()).toEqual("1Thess.1.1")
  ...
  describe("Localized book 2Tim (mr)", function() {
    ...
    return it("should handle book: 2Tim (mr)", function() {
		...
		expect(p.parse("2 तीमथ्य 1:1").osis()).toEqual("2Tim.1.1")
  ...
  describe("Localized book 1Tim (mr)", function() {
    ...
    return it("should handle book: 1Tim (mr)", function() {
		...
		expect(p.parse("1 तीमथ्य 1:1").osis()).toEqual("1Tim.1.1")
