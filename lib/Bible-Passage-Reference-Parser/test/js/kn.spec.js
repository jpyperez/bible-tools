(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle ranges (kn)", function() {
      ...
      return expect(p.parse("Phlm 2 ಗೆ 3").osis()).toEqual("Phlm.1.2-Phlm.1.3");
    });
    it("should handle chapters (kn)", function() {
      expect(p.parse("Titus 1:1, ಅಧ್ಯಾಯ 2").osis()).toEqual("Titus.1.1,Titus.2");
      return expect(p.parse("Matt 3:4 ಅಧ್ಯಾಯ 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    ...
    it("should handle book ranges (kn)", function() {
      ...
      return expect(p.parse("1 ಗೆ 3  ಯೋಹಾನ").osis()).toEqual("1John.1-3John.1");
    });
