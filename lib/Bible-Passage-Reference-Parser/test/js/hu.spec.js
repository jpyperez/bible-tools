(function() {
  ...
  describe("Localized book 2Chr (hu)", function() {
    ...
    return it("should handle book: 2Chr (hu)", function() {
		...
		expect(p.parse("II Kronika 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("II Krónika 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("Masodik Kr 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("Második Kr 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 Kronika 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 Krónika 1:1").osis()).toEqual("2Chr.1.1")
		...
		expect(p.parse("2 Kron 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("2 Krón 1:1").osis()).toEqual("2Chr.1.1")
		expect(p.parse("II. Kr 1:1").osis()).toEqual("2Chr.1.1")
  ...
  describe("Localized book 1Chr (hu)", function() {
    ...
    return it("should handle book: 1Chr (hu)", function() {
		...
		expect(p.parse("Elso Kr 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("Első Kr 1:1").osis()).toEqual("1Chr.1.1")
		...
		expect(p.parse("I. Kr 1:1").osis()).toEqual("1Chr.1.1")
		expect(p.parse("1 Kr 1:1").osis()).toEqual("1Chr.1.1")
  ...
  describe("Localized book Neh (hu)", function() {
    ...
    return it("should handle book: Neh (hu)", function() {
		...
		expect(p.parse("Nehémias 1:1").osis()).toEqual("Neh.1.1")
		expect(p.parse("Nehémiás 1:1").osis()).toEqual("Neh.1.1")
  ...
  describe("Localized book Ps (hu)", function() {
    ...
    return it("should handle book: Ps (hu)", function() {
		...
		expect(p.parse("Zsoltar 1:1").osis()).toEqual("Ps.1.1")
		expect(p.parse("Zsoltár 1:1").osis()).toEqual("Ps.1.1")
  ...
  describe("Localized book Prov (hu)", function() {
    ...
    return it("should handle book: Prov (hu)", function() {
		...
		expect(p.parse("Pld 1:1").osis()).toEqual("Prov.1.1")
		p.include_apocrypha(false)
		expect(p.parse("PELDABESZEDEK 1:1").osis()).toEqual("Prov.1.1")
		expect(p.parse("PELDABESZÉDEK 1:1").osis()).toEqual("Prov.1.1")
		expect(p.parse("PÉLDABESZEDEK 1:1").osis()).toEqual("Prov.1.1")
  ...
  describe("Localized book Song (hu)", function() {
    ...
    return it("should handle book: Song (hu)", function() {
		...
		expect(p.parse("Enekek 1:1").osis()).toEqual("Song.1.1")
		expect(p.parse("Énekek 1:1").osis()).toEqual("Song.1.1")
  ...
  describe("Localized book Ezek (hu)", function() {
    ...
    return it("should handle book: Ezek (hu)", function() {
		...
		expect(p.parse("Ezék 1:1").osis()).toEqual("Ezek.1.1")
  ...
  describe("Localized book Acts (hu)", function() {
    ...
    return it("should handle book: Acts (hu)", function() {
		...
		expect(p.parse("Csel 1:1").osis()).toEqual("Acts.1.1")
		p.include_apocrypha(false)
		expect(p.parse("AZ APOSTOLOK CSELEKEDETEI 1:1").osis()).toEqual("Acts.1.1")
		expect(p.parse("APOSTOLOK CSELEKEDETEI 1:1").osis()).toEqual("Acts.1.1")
		expect(p.parse("CSELEKEDETEK 1:1").osis()).toEqual("Acts.1.1")
  ...
  describe("Localized book 2Tim (hu)", function() {
    ...
    return it("should handle book: 2Tim (hu)", function() {
		...
		expect(p.parse("Masodik Timotheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("Masodik Timótheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("Második Timotheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("Második Timótheus 1:1").osis()).toEqual("2Tim.1.1")
		...
		expect(p.parse("II. Timótheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2 Timotheosz 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2 Timótheosz 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2. Timotheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("2. Timótheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("II Timotheus 1:1").osis()).toEqual("2Tim.1.1")
		expect(p.parse("II Timótheus 1:1").osis()).toEqual("2Tim.1.1")
  ...
  describe("Localized book 1Tim (hu)", function() {
    ...
    return it("should handle book: 1Tim (hu)", function() {
		...
		expect(p.parse("Elso Timotheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("Elso Timótheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("Első Timotheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("Első Timótheus 1:1").osis()).toEqual("1Tim.1.1")
		...
		expect(p.parse("1. Timótheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("I Timotheosz 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("I Timótheosz 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("I. Timotheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("I. Timótheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1 Timotheus 1:1").osis()).toEqual("1Tim.1.1")
		expect(p.parse("1 Timótheus 1:1").osis()).toEqual("1Tim.1.1")
  ...
  describe("Localized book 2Pet (hu)", function() {
    ...
    return it("should handle book: 2Pet (hu)", function() {
		...
		expect(p.parse("Masodik Pt 1:1").osis()).toEqual("2Pet.1.1")
		expect(p.parse("Második Pt 1:1").osis()).toEqual("2Pet.1.1")
  ...
  describe("Localized book 1Pet (hu)", function() {
    ...
    return it("should handle book: 1Pet (hu)", function() {
		...
		expect(p.parse("1 Peter 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("1 Péter 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("Elso Pt 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("Első Pt 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("I Peter 1:1").osis()).toEqual("1Pet.1.1")
		expect(p.parse("I Péter 1:1").osis()).toEqual("1Pet.1.1")
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle book ranges (hu)", function() {
      ...
      return expect(p.parse("Első kov Harmadik  Jn").osis()).toEqual("1John.1-3John.1");
    });
