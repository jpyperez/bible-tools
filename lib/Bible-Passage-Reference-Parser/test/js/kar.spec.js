(function() {
  ...
  describe("Localized book Gen (kar)", function() {
    ...
    return it("should handle book: Gen (kar)", function() {
  ...
  describe("Localized book Exod (kar)", function() {
    ...
    return it("should handle book: Exod (kar)", function() {
  ...
  describe("Localized book Lev (kar)", function() {
    ...
    return it("should handle book: Lev (kar)", function() {
  ...
  describe("Localized book Num (kar)", function() {
    ...
    return it("should handle book: Num (kar)", function() {
  ...
  describe("Localized book Deut (kar)", function() {
    ...
    return it("should handle book: Deut (kar)", function() {
  ...
  describe("Localized book 2Sam (kar)", function() {
    ...
    return it("should handle book: 2Sam (kar)", function() {
  ...
  describe("Localized book 1Sam (kar)", function() {
    ...
    return it("should handle book: 1Sam (kar)", function() {
  ...
  describe("Localized book 2Kgs (kar)", function() {
    ...
    return it("should handle book: 2Kgs (kar)", function() {
  ...
  describe("Localized book 1Kgs (kar)", function() {
    ...
    return it("should handle book: 1Kgs (kar)", function() {
  ...
  describe("Localized book 2Chr (kar)", function() {
    ...
    return it("should handle book: 2Chr (kar)", function() {
  ...
  describe("Localized book 1Chr (kar)", function() {
    ...
    return it("should handle book: 1Chr (kar)", function() {
  ...
  describe("Localized book 1Cor (kar)", function() {
    ...
    return it("should handle book: 1Cor (kar)", function() {
