(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:krv))\b/gi;
  ...
  bcv_parser.prototype.regexps.first = `(?:1|[೧1])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.second = `(?:2|[೨2])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.third = `(?:3|[೩3])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|ಮತ್ತು|(?:ಗೆ|ರಿಂದ))";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|(?:ಗೆ|ರಿಂದ))";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಆ(?:ದಿ(?:ಕಾಂಡ)?|\\.?ಕಾಂಡ|\\.?ಕಾ)|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ವಿ(?:ಮೋ(?:ಚನಕಾಂಡ)?|\\.?ಕಾಂಡ|\\.?ಕಾ)|Exod))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯಾಜ(?:ಕಕಾಂಡ)?|Lev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಸಂಖ್ಯಾಕಾಂಡ|ಅರಣ್ಯಕಾಂಡ|ಯಾಕಾಂಡ|ಅರಣ್ಯ|Num))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
      ...
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರಲಾ(?:ಪಗಳು)?|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರಕ(?:ಟನೆ)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಧ(?:ರ್ಮೋ(?:ಪದೇಶಕಾಂಡ)?|\\.?ಕಾಂಡ|\\.?ಕಾ)|Deut))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯೆಹೋ(?:ಶುವ)?|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ನ್ಯಾಯ(?:ಸ್ಥಾಪಕರು)?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ರೂತ(?:ಳು)?|Ruth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
      ...
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಯೆಶಾಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಯೆಶಾಯ|ಯೆಶಾ|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಸಮುವೇಲನು|2(?:[\s\xa0]*ಸಮು(?:ವೇಲ(?:ನು)?)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಸಮುವೇಲನು|1(?:[\s\xa0]*ಸಮು(?:ವೇಲ(?:ನು)?)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಅರಸುಗಳು|2(?:[\s\xa0]*ಅರಸು(?:ಗಳು)?|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಅರಸುಗಳು|1(?:[\s\xa0]*ಅರಸು(?:ಗಳು)?|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಪೂ(?:ರ್ವಕಾಲದ[\s\xa0]*ಇತಿಹಾಸ|(?:\.ವೃ\.?|ವೃ\.?)ಕಾ)|2(?:[\s\xa0]*ಪೂ(?:ರ್ವ(?:ಕಾಲ(?:ವೃತ್ತಾಂತ|ದ[\s\xa0]*ಇತಿಹಾಸ))?|(?:\.ವೃ\.?|ವೃ\.?)ಕಾ)|\.[\s\xa0]*ಪೂ\.ವೃ\.?ಕಾ|\.[\s\xa0]*ಪೂವೃ\.?ಕಾ|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಪೂ(?:ರ್ವಕಾಲದ[\s\xa0]*ಇತಿಹಾಸ|(?:\.ವೃ\.?|ವೃ\.?)ಕಾ)|1(?:[\s\xa0]*ಪೂ(?:ರ್ವ(?:ಕಾಲ(?:ವೃತ್ತಾಂತ|ದ[\s\xa0]*ಇತಿಹಾಸ))?|(?:\.ವೃ\.?|ವೃ\.?)ಕಾ)|\.[\s\xa0]*ಪೂ\.ವೃ\.?ಕಾ|\.[\s\xa0]*ಪೂವೃ\.?ಕಾ|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಎಜ್ರ(?:ನು)?|Ezra))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ನೆಹೆ(?:ಮೀಯ)?|Neh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
      ...
      {
        osis: ["Esth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಎಸ್ತೇ(?:ರಳು)?|Esth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Job"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯೋಬ(?:ನು(?:[\\s\\xa0]*ಗ್ರಂಥ)?)?|Job))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಕೀರ್ತ(?:ನೆ(?:ಗಳು)?)?|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಜ್ಞಾ(?:ನೋ(?:ಕ್ತಿಗಳು)?)?|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರಸ(?:ಂಗಿ)?|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
      ...
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ(?:ರಮಗೀತೆ?|\\.?ಗೀ)|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಯೆರೆಮೀಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಯೆರೆಮೀಯ|ಯೆರೆ|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಯೆಜೆಕಿಯೇಲನ[\\s\\xa0]*ಗ್ರಂಥ|ಯೆಹೆಜ್ಕೇಲ|ಯೆಹೆ|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ದಾನಿಯೇಲನ[\\s\\xa0]*ಗ್ರಂಥ|ದಾನಿಯೇಲನು|ದಾನಿ|Dan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಹೋಶೇಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಹೋಶೇಯ|ಹೋಶೇ|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಯೋವೇಲನ[\\s\\xa0]*ಗ್ರಂಥ|ಯೋವೇಲ|ಯೋವೇ|Joel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಆಮೋಸನ[\\s\\xa0]*ಗ್ರಂಥ|ಆಮೋಸ|Amos|ಆಮೋ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಓಬದ್ಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಓಬದ್ಯ|Obad|ಓಬ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಯೋನನ[\\s\\xa0]*ಗ್ರಂಥ|Jonah|ಯೋನ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಮೀಕನ[\\s\\xa0]*ಗ್ರಂಥ|ಮೀಕ|Mic))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ನಹೂಮನ[\\s\\xa0]*ಗ್ರಂಥ|ನಹೂಮ|ನಹೂ|Nah))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಹಬಕ್ಕೂಕನ[\\s\\xa0]*ಗ್ರಂಥ|ಹಬಕ್ಕೂಕ|Hab|ಹಬ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಜೆಫನ್ಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಚೆಫನ್ಯ|Zeph|ಚೆಫ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಹಗ್ಗಾಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಹಗ್ಗಾಯ|ಹಗ್ಗಾ|Hag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಜೆಕರ್ಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಜೆಕರ್ಯ|Zech|ಜೆಕ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರವಾದಿ[\\s\\xa0]*ಮಲಾಕಿಯನ[\\s\\xa0]*ಗ್ರಂಥ|ಮಲಾಕಿಯ|ಮಲಾ|Mal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಮತ್ತಾಯ?|Matt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಮಾರ್ಕ|Mark))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Luke|ಲೂಕ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾನ)|1(?:[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾ(?:ನನು|ನ)?)|\.[\s\xa0]*ಯೋಹಾನ|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾನ)|2(?:[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾ(?:ನನು|ನ)?)|\.[\s\xa0]*ಯೋಹಾನ|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೩[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾನ)|3(?:[\s\xa0]*ಯ(?:ೊವಾನ್ನನು|ೋಹಾ(?:ನನು|ನ)?)|\.[\s\xa0]*ಯೋಹಾನ|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯ(?:ೊವಾನ್ನ|ೋಹಾನ?)|John))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಪ್ರೇಷಿತರ[\\s\\xa0]*ಕಾರ್ಯಕಲಾಪಗಳು|ಅಪೊಸ್ತಲರ[\\s\\xa0]*ಕೃತ್ಯಗಳು|ಅ\\.?[\\s\\xa0]*ಕೃ|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ರೋಮ(?:ಾ(?:ಪುರದವರಿಗೆ)?|ನರಿಗೆ)?|Rom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಕೊರಿಂಥ(?:ಿಯರಿಗೆ)?|2(?:[\s\xa0]*ಕೊರಿ(?:ಂಥ(?:ಿಯರಿಗೆ|ದವರಿಗೆ)?)?|\.[\s\xa0]*ಕೊರಿಂಥ|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಕೊರಿಂಥ(?:ಿಯರಿಗೆ)?|1(?:[\s\xa0]*ಕೊರಿ(?:ಂಥ(?:ಿಯರಿಗೆ|ದವರಿಗೆ)?)?|\.[\s\xa0]*ಕೊರಿಂಥ|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಗಲಾ(?:ತ್ಯ(?:ದವರಿಗೆ|ರಿಗೆ)?)?|Gal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಎಫೆ(?:ಸ(?:ಿಯರಿಗೆ|ದವರಿಗೆ)?)?|Eph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಫಿಲಿ(?:ಪ್ಪಿ(?:ಯವ?ರಿಗೆ)?)?|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಕೊಲೊ(?:ಸ್ಸೆಯವ?ರಿಗೆ)?|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*ಥೆಸ(?:ಲೋನಿ(?:ಕದವ|ಯ)ರಿಗೆ)?|Thess)|೨[\s\xa0]*ಥೆಸಲೋನಿಯರಿಗೆ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*ಥೆಸ(?:ಲೋನಿ(?:ಕದವ|ಯ)ರಿಗೆ)?|Thess)|೧[\s\xa0]*ಥೆಸಲೋನಿಯರಿಗೆ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ತಿಮೊಥ(?:ೇಯನಿಗೆ|ಿ)|2(?:[\s\xa0]*ತಿಮೊ(?:ಥ(?:[ೆೇ]ಯನಿಗೆ|ಿ))?|\.[\s\xa0]*ತಿಮೊಥಿ|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ತಿಮೊಥ(?:ೇಯನಿಗೆ|ಿ)|1(?:[\s\xa0]*ತಿಮೊ(?:ಥ(?:[ೆೇ]ಯನಿಗೆ|ಿ))?|\.[\s\xa0]*ತಿಮೊಥಿ|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ತೀತ(?:ನಿಗೆ)?|Titus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಫಿಲೆ(?:ಮೋನನಿಗೆ)?|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಹಿಬ್ರಿಯರಿಗೆ|ಇಬ್ರಿಯರಿಗೆ|ಇಬ್ರಿಯ?|Heb))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯಾಕೋ(?:ಬನು)?|Jas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಪೇತ್ರನು|2(?:[\s\xa0]*ಪೇತ್ರ(?:ನು)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಪೇತ್ರನು|1(?:[\s\xa0]*ಪೇತ್ರ(?:ನು)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಯೂದ(?:ನು)?|Jude))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c60 = "\u0C85\u0CA7\u0CCD\u0CAF\u0CBE\u0CAF",
        peg$c61 = peg$literalExpectation("\u0C85\u0CA7\u0CCD\u0CAF\u0CBE\u0CAF", true),
        peg$c62 = "",
        peg$c63 = "\u0C97\u0CB3\u0CC1",
        peg$c64 = peg$literalExpectation("\u0C97\u0CB3\u0CC1", true),
        peg$c65 = function() { return {"type": "c_explicit"} },
        peg$c66 = "\u0CAA\u0CA6\u0CCD\u0CAF",
        peg$c67 = peg$literalExpectation("\u0CAA\u0CA6\u0CCD\u0CAF", true),
        ...
        peg$c75 = "\u0CAE\u0CA4\u0CCD\u0CA4\u0CC1",
        peg$c76 = peg$literalExpectation("\u0CAE\u0CA4\u0CCD\u0CA4\u0CC1", true),
        peg$c77 = function() { return "" },
        peg$c78 = /^[\-\u2013\u2014]/,
        peg$c79 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c80 = "\u0C97\u0CC6",
        peg$c81 = peg$literalExpectation("\u0C97\u0CC6", true),
        peg$c82 = "\u0CB0\u0CBF\u0C82\u0CA6",
        peg$c83 = peg$literalExpectation("\u0CB0\u0CBF\u0C82\u0CA6", true),
        peg$c84 = "title",
