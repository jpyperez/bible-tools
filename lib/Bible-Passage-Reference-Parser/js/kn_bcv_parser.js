(function() {
  ...
  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|ಮತ್ತು|ಗೆ)";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|ಗೆ)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಆ(?:ದಿ(?:ಕಾಂಡ)?|\\.?ಕಾ)|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ವಿ(?:ಮೋ(?:ಚನಕಾಂಡ)?|\\.?ಕಾ)|Exod))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಸಂಖ್ಯಾಕಾಂಡ|ಅರಣ್ಯಕಾಂಡ|ಅರಣ್ಯ|Num))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಧ(?:ರ್ಮೋ(?:ಪದೇಶಕಾಂಡ)?|\\.?ಕಾ)|Deut))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
      ...
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೨[\s\xa0]*ಸಮುವೇಲನು|2(?:[\s\xa0]*ಸಮು(?:ವೇಲನು)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:೧[\s\xa0]*ಸಮುವೇಲನು|1(?:[\s\xa0]*ಸಮು(?:ವೇಲನು)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
      ...
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಗಲಾ(?:ತ್ಯ(?:ದವ)?ರಿಗೆ)?|Gal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
      ...
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ಫಿಲಿಪ್ಪಿ(?:ಯವ?ರಿಗೆ)?|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c63 = "\u0CAA\u0CA6\u0CCD\u0CAF",
        peg$c64 = peg$literalExpectation("\u0CAA\u0CA6\u0CCD\u0CAF", true),
        ...
        peg$c72 = "\u0CAE\u0CA4\u0CCD\u0CA4\u0CC1",
        peg$c73 = peg$literalExpectation("\u0CAE\u0CA4\u0CCD\u0CA4\u0CC1", true),
        peg$c74 = function() { return "" },
        peg$c75 = /^[\-\u2013\u2014]/,
        peg$c76 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c77 = "\u0C97\u0CC6",
        peg$c78 = peg$literalExpectation("\u0C97\u0CC6", true),
        peg$c79 = "title",
