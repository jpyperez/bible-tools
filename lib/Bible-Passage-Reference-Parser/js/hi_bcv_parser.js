(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:उत्(?:त्पत्ति|प(?:त्ति|ाति|[0०॰]))|Utpaati|Gen))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Exod"],
      ...
      {
        osis: ["Ps"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:पढ़ें[\s\xa0]*भजन[\s\xa0]*सं[0०]|भजन(?:\-?सहिन्ता|[\s\xa0]*स(?:ंहिता|[0०]))|Bhjan|भजन|Ps))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["PrAzar"],
        apocrypha: true,
      ...
      {
        osis: ["Eccl"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:Sabhopadeshak|सभोप(?:देशक|[0०])|Eccl|सभो))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["SgThree"],
        apocrypha: true,
      ...
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Yahejakel|यहेजकेल|यहेज|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Matt(?:ee)?|मत्ती))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
      ...
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:क(?:ुर(?:ि(?:न्(?:यि़|थि)यों|[0०])|न्थियों)|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:ि(?:न्(?:यि़|थि)यों|[0०])|न्थियों)|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:क(?:ुर(?:ि(?:न्(?:यि़|थि)यों|[0०])|न्थियों)|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:ि(?:न्(?:यि़|थि)यों|[0०])|न्थियों)|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
      ...
      {
        osis: ["Phil"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:फिलि(?:प्(?:पियों|‍पी)|[0०])|Filippaiyon|फिलिप्पि|Phil))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Col"],
      ...
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्स(?:लुनीकियों|[0०])|लुनिकी|्स))|[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्स(?:लुनीकियों|[0०])|लुनिकी|्स))|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्स(?:लुनीकियों|[0०])|लुनिकी|्स))|[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्स(?:लुनीकियों|[0०])|लुनिकी|्स))|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
      ...
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:Pataras|पत(?:(?:्रु|र)स|र))|[\s\xa0]*(?:Pataras|पत(?:(?:्रु|र)स|र))|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:Pataras|पत(?:(?:्रु|र)स|र))|[\s\xa0]*(?:Pataras|पत(?:(?:्रु|र)स|र))|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
