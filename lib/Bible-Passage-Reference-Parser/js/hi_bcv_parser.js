(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|कुरि[0०]|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|कुरि[0०]|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
