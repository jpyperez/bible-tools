(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:उत्प(?:त्|ा)ति|Utpaati|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Nirgaman|निर्गमन|Exod))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:L(?:aaivyavyavastha|ev)|लैव्य(?:(?:्व्य्व|व(?:्यव)?)स्था|व्यवस्थ)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
      ...
      {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:Vyavasthaavivaran|व्य(?:्वस्थाविवरन|वस्था[\s\xa0]*?विवरण|[0०][\s\xa0]*वि[0०])|व्यवस्था|Deut))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Josh"],
      ...
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:yashaayaah|यशायाह|यशा(?:या)?|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:शमुऐयल[\s\xa0]*की[\s\xa0]*[2२]री[\s\xa0]*पुस्तक|2(?:\.[\s\xa0]*(?:Shamooael|शमूएल)|[\s\xa0]*(?:Shamooael|शमूएल)|\.?[\s\xa0]*शमू|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:शमुऐल[\s\xa0]*की[\s\xa0]*[1१]ली[\s\xa0]*पुस्तक|1(?:\.[\s\xa0]*(?:Shamooael|शमूएल)|[\s\xa0]*(?:Shamooael|शमूएल)|\.?[\s\xa0]*शमू|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:भजन(?:\\-?सहिन्ता|[\\s\\xa0]*संहिता)?|Bhjan|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Neetivachan|नीति(?:[\\s\\xa0]*व|[बव])चन|नीति|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sabhopadeshak|सभोपदेशक|Eccl|सभो))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
      ...
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:यिर्मयाह|Yirmayah|यिर्म|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
      ...
      {
        osis: ["Dan"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:दानि(?:य्ये?ल|[0०])?|Da(?:aniyyel|n)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Hos"],
      ...
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mar(?:akus|k)|मरकुस))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
      ...
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:प्र(?:ेरितों[\\s\\xa0]*के[\\s\\xa0]*काम(?:ों)?|(?:\\.[\\s\\xa0]*?|[\\s\\xa0]*)?क)|Praeriton[\\s\\xa0]*Ke[\\s\\xa0]*Kam|मसीह\\-?दूत|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:रोम(?:ियों|ियो|[0ी०])|Rom(?:iyon)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|[\s\xa0]*(?:क(?:ुर(?:िन्(?:यि़|थि)|न्थि)यों|ुरिन्थ(?:ियो)?|ोरिन्‍थी)|Kurinthiayon)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
      ...
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Iafisiyon|इफिस(?:ियों|ी)|इफिसि|Eph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
      ...
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्सलुनीकियों|लुनिकी|्स))|[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्सलुनीकियों|लुनिकी|्स))|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्सलुनीकियों|लुनिकी|्स))|[\s\xa0]*(?:Thaissaluneekiyon|थिस(?:्सलुनीकियों|लुनिकी|्स))|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:2(?:\.[\s\xa0]*(?:Teemuathaiyus|त(?:(?:ीमु(?:ाथै|थि)|िमुथि)युस|ीम))|[\s\xa0]*(?:Teemuathaiyus|त(?:(?:ीमु(?:ाथै|थि)|िमुथि)युस|ीम))|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿ꣠-ꣷꣻ])((?:1(?:\.[\s\xa0]*(?:Teemuathaiyus|त(?:(?:ीमु(?:ाथै|थि)|िमुथि)युस|ीम))|[\s\xa0]*(?:Teemuathaiyus|त(?:(?:ीमु(?:ाथै|थि)|िमुथि)युस|ीम))|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
