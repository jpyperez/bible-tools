...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ဆာ(?:[\\s\\xa0]*လံ[\\s\\xa0]*ကျမ်း။|၊)?|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ရော(?:[\\s\\xa0]*မ[\\s\\xa0]*ဩ[\\s\\xa0]*ဝါ[\\s\\xa0]*ဒ[\\s\\xa0]*စာ။|မ)?|Rom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c63 = "\u1021\u1001\u1014\u103A\u1038\u1004\u101A\u103A",
        peg$c64 = peg$literalExpectation("\u1021\u1001\u1014\u103A\u1038\u1004\u101A\u103A", true),
        ...
        peg$c72 = "\u1014\u103E\u1004\u1037\u103A",
        peg$c73 = peg$literalExpectation("\u1014\u103E\u1004\u1037\u103A", true),
        peg$c74 = "\u104A",
        ...
        peg$c79 = "\u1019\u103E",
        peg$c80 = peg$literalExpectation("\u1019\u103E", true),
        peg$c81 = "title",
