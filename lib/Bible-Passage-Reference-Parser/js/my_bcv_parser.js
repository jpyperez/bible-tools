...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:trans))\b/gi;
  ...
  bcv_parser.prototype.languages = ["my"];

  bcv_parser.prototype.regexps.space = "[\\s\\xa0]";

  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|title(?![a-z])|အခန်းငယ်|အခန်း|နှင့်|ff|မှ|း|၊|း|[a-e](?!\w)|$)+)/gi; // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
  ...
  bcv_parser.prototype.regexps.match_end_split = /\d\W*title|\d\W*ff(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[a-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi; //ff09 is a full-width closing parenthesis

  bcv_parser.prototype.regexps.control = /[\x1e\x1f]/g;

  bcv_parser.prototype.regexps.pre_book = "[^A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ]";

  bcv_parser.prototype.regexps.first = `(?:1|[၁1])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.second = `(?:2|[၂2])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.third = `(?:3|[၃3])\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|(?:နှင့်|၊)|မှ)";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|မှ)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:က(?:[\\s\\xa0]*မ္ဘာ[\\s\\xa0]*[ဥဦ]း[\\s\\xa0]*ကျမ်း။|(?:မ္ဘာ)?၊)?|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ထ(?:ွ(?:က်(?:[\\s\\xa0]*မြောက်[\\s\\xa0]*ရာ[\\s\\xa0]*ကျမ်း။|၊))?|ကွ[\\s\\xa0]*၊်)|Exod))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Bel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ဝတ်(?:[\\s\\xa0]*ပြု[\\s\\xa0]*ရာ[\\s\\xa0]*ကျမ်း။|၊)?|Lev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:တော(?:[\\s\\xa0]*လည်[\\s\\xa0]*ရာ[\\s\\xa0]*ကျမ်း။|၊)?|Num))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sir))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ယေ[\\s\\xa0]*ရ[\\s\\xa0]*မိ[\\s\\xa0]*မြည်[\\s\\xa0]*တမ်း[\\s\\xa0]*စ[\\s\\xa0]*ကား။|မြည်|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ဗျာ(?:[\\s\\xa0]*ဒိတ်[\\s\\xa0]*ကျမ်း။|၊)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:တ(?:[\\s\\xa0]*ရား[\\s\\xa0]*ဟော[\\s\\xa0]*ရာ[\\s\\xa0]*ကျမ်း။|ရား(?:‌ဟော|ဟော၊)?)|Deut))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ယော(?:[\\s\\xa0]*ရှု[\\s\\xa0]*မှတ်[\\s\\xa0]*စာ။|ရှု)|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:တ[\\s\\xa0]*ရား[\\s\\xa0]*သူ[\\s\\xa0]*ကြီး[\\s\\xa0]*မှတ်[\\s\\xa0]*စာ။|သူကြီး|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ရု(?:​သ​ဝ​တ္တု။)?|Ruth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:1Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:2Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ဟေ(?:[\\s\\xa0]*ရှာ[\\s\\xa0]*ယ[\\s\\xa0]*အ[\\s\\xa0]*နာ[\\s\\xa0]*ဂ[\\s\\xa0]*တ္တိ[\\s\\xa0]*ကျမ်း။|ရှာ(?:ယ?၊)?)|‌ဟေရာှ|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ဓ[\s\xa0]*မ္မ[\s\xa0]*ရာ[\s\xa0]*ဇ[\s\xa0]*ဝင်[\s\xa0]*ဒု[\s\xa0]*တိ[\s\xa0]*ယ[\s\xa0]*စောင်။|2(?:\.[\s\xa0]*?ရာ၊|[\s\xa0]*ရာ၊|Sam|ရာ၊)|၂[\s\xa0]*?ရာ၊|[2၂][\s\xa0]*ရာ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ဓ[\s\xa0]*မ္မ[\s\xa0]*ရာ[\s\xa0]*ဇ[\s\xa0]*ဝင်[\s\xa0]*ပ[\s\xa0]*ထ[\s\xa0]*မ[\s\xa0]*စောင်။|1(?:\.[\s\xa0]*?ရာ၊|[\s\xa0]*ရာ၊|Sam|ရာ၊)|၁[\s\xa0]*?ရာ၊|[1၁][\s\xa0]*ရာ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ဓ[\s\xa0]*မ္မ[\s\xa0]*ရာ[\s\xa0]*ဇ[\s\xa0]*ဝင်[\s\xa0]*စ[\s\xa0]*တု[\s\xa0]*တ္ထ[\s\xa0]*စောင်။|4(?:\.[\s\xa0]*?|[\s\xa0]*)?ရာ၊|၄[\s\xa0]*ရာ၊|[4၄][\s\xa0]*ရာ|2Kgs|၄ရာ၊))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ဓ[\s\xa0]*မ္မ[\s\xa0]*ရာ[\s\xa0]*ဇ[\s\xa0]*ဝင်[\s\xa0]*တ[\s\xa0]*တိ[\s\xa0]*ယ[\s\xa0]*စောင်။|3(?:\.[\s\xa0]*?|[\s\xa0]*)?ရာ၊|၃[\s\xa0]*ရာ၊|[3၃][\s\xa0]*ရာ|1Kgs|၃ရာ၊))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ရာ[\s\xa0]*ဇ[\s\xa0]*ဝင်[\s\xa0]*ချုပ်[\s\xa0]*ဒု[\s\xa0]*တိ[\s\xa0]*ယ[\s\xa0]*စောင်။
\\s\\xa0]*ဩ[\\s\\xa0]*ဝါ[\\s\\xa0]*ဒ[\\s\\xa0]*စာ။|လေ)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ဟေဗြဲ၊)|(?:ဟေ(?:[\\s\\xa0]*ဗြဲ(?:[\\s\\xa0]*ဩ[\\s\\xa0]*ဝါ[\\s\\xa0]*ဒ[\\s\\xa0]*စာ။)?|ဗြဲ)|Heb))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ရှင်[\\s\\xa0]*ယာ[\\s\\xa0]*ကုပ်[\\s\\xa0]*ဩ[\\s\\xa0]*ဝါ[\\s\\xa0]*ဒ[\\s\\xa0]*စာ။|ယာကုပ်၊|Jas|ယာ))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ရှင်[\s\xa0]*ပေ[\s\xa0]*တ[\s\xa0]*ရု[\s\xa0]*ဩ[\s\xa0]*ဝါ[\s\xa0]*ဒ[\s\xa0]*စာ[\s\xa0]*ဒု[\s\xa0]*တိ[\s\xa0]*ယ[\s\xa0]*စောင်။|2(?:\.[\s\xa0]*?ပေ၊|[\s\xa0]*ပေ၊|Pet|ပေ၊)|၂[\s\xa0]*?ပေ၊|[2၂][\s\xa0]*ပေ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:ရှင်[\s\xa0]*ပေ[\s\xa0]*တ[\s\xa0]*ရု[\s\xa0]*သြ[\s\xa0]*ဝါ[\s\xa0]*ဒ[\s\xa0]*စာ[\s\xa0]*ပ[\s\xa0]*ထ[\s\xa0]*မ[\s\xa0]*စောင်။|1(?:\.[\s\xa0]*?ပေ၊|[\s\xa0‌]*ပေ၊|Pet|ပေ၊)|၁[\s\xa0‌]*?ပေ၊|(?:၁[\s\xa0‌]*|1[\s\xa0‌]*)ပေ))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ရှင်[\\s\\xa0]*ယု[\\s\\xa0]*ဒ[\\s\\xa0]*ဩ[\\s\\xa0]*ဝါ[\\s\\xa0]*ဒ[\\s\\xa0]*စာ။|Jude|ယု))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Tob))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Jdt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Bar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:2Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:3Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:4Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏက-ဪိ-ူဲ-့္-်ွ-ဿၐ-ၕၘ-ၡၥ-ၦၮ-ႂႅ-ႆႍ-ႎႝḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿꩠ-ꩶꩺ])((?:1Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c60 = "\u1021\u1001\u1014\u103A\u1038",
        peg$c61 = peg$literalExpectation("\u1021\u1001\u1014\u103A\u1038", true),
        peg$c62 = "\u1038",
        peg$c63 = peg$literalExpectation("\u1038", true),
        peg$c64 = function() { return {"type": "c_explicit"} },
        peg$c65 = "\u1021\u1001\u1014\u103A\u1038\u1004\u101A\u103A",
        peg$c66 = peg$literalExpectation("\u1021\u1001\u1014\u103A\u1038\u1004\u101A\u103A", true),
        ...
        peg$c74 = "\u1014\u103E\u1004\u1037\u103A",
        peg$c75 = peg$literalExpectation("\u1014\u103E\u1004\u1037\u103A", true),
        peg$c76 = "\u104A",
        peg$c77 = peg$literalExpectation("\u104A", true),
        peg$c78 = function() { return "" },
        peg$c79 = /^[\-\u2013\u2014]/,
        peg$c80 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c81 = "\u1019\u103E",
        peg$c82 = peg$literalExpectation("\u1019\u103E", true),
        peg$c83 = "title",
        peg$c84 = peg$literalExpectation("title", false),
        peg$c85 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c86 = "from",
        peg$c87 = peg$literalExpectation("from", false),
        peg$c88 = "of",
        peg$c89 = peg$literalExpectation("of", false),
        peg$c90 = "in",
        peg$c91 = peg$literalExpectation("in", false),
        peg$c92 = "the",
        peg$c93 = peg$literalExpectation("the", false),
        peg$c94 = "book",
        peg$c95 = peg$literalExpectation("book", false),
        peg$c96 = /^[([]/,
        peg$c97 = peg$classExpectation(["(", "["], false, false),
        peg$c98 = /^[)\]]/,
        peg$c99 = peg$classExpectation([")", "]"], false, false),
        peg$c100 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c101 = "\x1E",
        peg$c102 = peg$literalExpectation("\x1E", false),
        peg$c103 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c104 = ",000",
        peg$c105 = peg$literalExpectation(",000", false),
        peg$c106 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c107 = /^[^\x1F\x1E([]/,
        peg$c108 = peg$classExpectation(["\x1F", "\x1E", "(", "["], true, false),
        peg$c109 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c110 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c111 = /^[\s\xa0*]/,
