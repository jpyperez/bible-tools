...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Eze(?:quiel|kiel|k)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:II(?:\.[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?))|2(?:\.[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:\.[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?))|1(?:\.[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|[\s\xa0]*(?:Taga[\s\xa0]*Corinto|Cor(?:int[ho])?)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
      ...
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Taga[\\s\\xa0]*Filipos|Filipios|Filipos|Fili?|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
