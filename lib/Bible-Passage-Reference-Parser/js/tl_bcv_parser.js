(function() {
  ...
  bcv_parser.prototype.languages = ["tl"];

  bcv_parser.prototype.regexps.space = "[\\s\\xa0]";

  // Start inverted book/chapter (cb)
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|(?:titik|pamagat)(?![a-z])|kapitulo|talatang|pangkat|pang|kap|tal|at|k|-|[a-e](?!\w)|$)+)/gi; // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
  ...
  bcv_parser.prototype.regexps.match_end_split = /\d\W*(?:titik|pamagat)|\d\W*k(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[a-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi; //ff09 is a full-width closing parenthesis
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Henesis|Gen(?:esis)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ex(?:o(?:d(?:us|o)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Si[\\s\\xa0]*Bel[\\s\\xa0]*at[\\s\\xa0]*ang[\\s\\xa0]*Dragon|Bel(?:[\\s\\xa0]*at[\\s\\xa0]*ang[\\s\\xa0]*Dragon)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Le(?:b(?:iti(?:kus|co))?|v(?:itico)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mga[\\s\\xa0]*Bilang|B[ae]midbar|Bilang|Bil|Num|Blg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Karunungan[\\s\\xa0]*ni[\\s\\xa0]*Jesus,?[\\s\\xa0]*Anak[\\s\\xa0]*ni[\\s\\xa0]*Sirac|Karunungan[\\s\\xa0]*ng[\\s\\xa0]*Anak[\\s\\xa0]*ni[\\s\\xa0]*Sirac|E(?:k(?:kles[iy]|les[iy])astik(?:us|o)|c(?:clesiastic(?:us|o)|lesiastico))|Sir(?:\\xE1(?:[ck]id[ae]s|[ck]h)|a(?:k(?:id[ae]s|h)|c(?:id[ae]s|h)))|Sir(?:\\xE1[ck]id[ae]|a(?:k(?:id[ae])?|cid[ae])|\\xE1[ck])?)|(?:Sirac))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Aklat[\\s\\xa0]*ng[\\s\\xa0]*Pa(?:nan|gt)aghoy|Mga[\\s\\xa0]*Lamentasyon|Mga[\\s\\xa0]*Panaghoy|Panaghoy|Panag|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Liham[\\s\\xa0]*ni[\\s\\xa0]*Jeremias|Liham[\\s\\xa0]*ni[\\s\\xa0]*Jeremias|(?:Li(?:[\\s\\xa0]*ni|h)[\\s\\xa0]*|Ep)Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Apo[ck](?:alipsis(?:[\\s\\xa0]*ni[\\s\\xa0]*Juan)?)?|Pahayag[\\s\\xa0]*kay[\\s\\xa0]*Juan|Rebelasyon|Pah(?:ayag)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Panalangin[\\s\\xa0]*ni[\\s\\xa0]*Manases|Panalangin[\\s\\xa0]*ni[\\s\\xa0]*Manases|Dalangin[\\s\\xa0]*ni[\\s\\xa0]*Manases|Dasal[\\s\\xa0]*ni[\\s\\xa0]*Manases|PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:D(?:i?yuteronomyo|e(?:yuteronomyo|ut(?:eronom(?:i(?:y[ao]|[ao])?|y?a))?)|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Jos(?:h(?:ua)?|u[e\\xE9])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mga[\\s\\xa0]*Hukom|Hukom|Judg|Huk))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ruth?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|[1I]\.[\s\xa0]*E(?:sdras|zra)|1(?:[\s\xa0]*Esdras|[\s\xa0]*Ezra|[\s\xa0]*Esd|Esd)|I[\s\xa0]*E(?:sdras|zra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang[\s\xa0]*E(?:sdras|zra)|I(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra)))|2(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*Esdras|[\s\xa0]*Ezra|[\s\xa0]*Esd|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Is(?:a(?:[i\\xED]a[hs]?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang|I\.?)[\s\xa0]*Samuel|2(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel|[\s\xa0]*?Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng)?[\s\xa0]*Samuel|[1I]\.[\s\xa0]*Samuel|1(?:[\s\xa0]*Samuel|[\s\xa0]*?Sam)|I[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:ka(?:lawang[\s\xa0]*(?:Mga[\s\xa0]*)?|apat[\s\xa0]*Mga[\s\xa0]*)|V\.?[\s\xa0]*Mga[\s\xa0]*|I\.[\s\xa0]*(?:Mga[\s\xa0]*)?|I[\s\xa0]*(?:Mga[\s\xa0]*)?)Hari|(?:4\.|[24])[\s\xa0]*Mga[\s\xa0]*Hari|2\.[\s\xa0]*(?:Mga[\s\xa0]*)?Hari|2(?:[\s\xa0]*Hari|[\s\xa0]*Ha|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:katlong[\s\xa0]*Mga|II\.[\s\xa0]*Mga|II[\s\xa0]*Mga|\.?[\s\xa0]*Mga|\.)?[\s\xa0]*Hari|(?:Unang|Una|1\.|1)[\s\xa0]*Mga[\s\xa0]*Hari|3\.[\s\xa0]*Mga[\s\xa0]*Hari|(?:Unang|Una|1\.)[\s\xa0]*Hari|3[\s\xa0]*Mga[\s\xa0]*Hari|1(?:[\s\xa0]*Hari|[\s\xa0]*Ha|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)|I(?:\.[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)|[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)))|2(?:\.[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)|[\s\xa0]*Paralipomeno|[\s\xa0]*Mga[\s\xa0]*(?:Kronik|Cronic)a|[\s\xa0]*Chronicle|[\s\xa0]*Kronik(?:el|a)|[\s\xa0]*Cronica|[\s\xa0]*Cron?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)|[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica))|[1I]\.[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)|1(?:[\s\xa0]*Paralipomeno|[\s\xa0]*Mga[\s\xa0]*(?:Kronik|Cronic)a|[\s\xa0]*Chronicle|[\s\xa0]*Kronik(?:el|a)|[\s\xa0]*Cronica|[\s\xa0]*Cron?|Chr)|I[\s\xa0]*(?:Paralipomeno|Mga[\s\xa0]*(?:Kronik|Cronic)a|Chronicle|Kronik(?:el|a)|Cronica)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:E(?:sdras|zra)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Neh(?:em[i\\xED]a[hs])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Est(?:er[\\s\\xa0]*(?:\\(Gr(?:iy?|y)?ego\\)|Gr(?:iy?|y)?ego)|g)|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Esth"],
      ...
      },
      {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Aw(?:it[\s\xa0]*ng[\s\xa0]*(?:Tatlong[\s\xa0]*(?:B(?:anal[\s\xa0]*na[\s\xa0]*Kabataan|inata)|Kabataan(?:g[\s\xa0]*Banal)?)|3[\s\xa0]*Kabataan)|[\s\xa0]*ng[\s\xa0]*3[\s\xa0]*Kab)|Tatlong[\s\xa0]*Kabataan|SgThree))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Song"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mga[\\s\\xa0]*(?:Salmo|Awit)|Salmo|Awit|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Karunungan[\\s\\xa0]*ni[\\s\\xa0]*S[ao]lom[o\\xF3]n|Karunungan[\\s\\xa0]*ni[\\s\\xa0]*S[ao]lom[o\\xF3]n|Kar(?:unungan)?|S[ao]lom[o\\xF3]n|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Panalangin[\\s\\xa0]*ni[\\s\\xa0]*Azarias|P(?:analangin[\\s\\xa0]*ni[\\s\\xa0]*Azarias|rAzar)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mga[\\s\\xa0]*Kawikaan|Kawikaan|Prov|Kaw))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ang[\\s\\xa0]*Mangangaral|E(?:c(?:clesiaste|l(?:es[iy]ast[e\\xE9]|is[iy]aste))|kl(?:es[iy]ast[e\\xE9]|is[iy]aste))s|Mangangaral|Kohelet|Manga|Ec(?:cl)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:(?:Sulat[\\s\\xa0]*ni[\\s\\xa0]*Jeremi|H[ei]r[ei]m[iy])as|Aklat[\\s\\xa0]*ni[\\s\\xa0]*Jeremia[hs]|Jeremia[hs]|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:E(?:ze(?:quiel|k[iy]el|k)?|sek[iy]el)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Hos(?:e(?:ias?|as?))?|Os(?:e(?:ia[hs]|a[hs])|ei?a)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Yole|Joel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Am[o\\xF3]s))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Oba(?:d(?:ia[hs])?)?|Abd[i\\xED]as))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Jon(?:[a\\xE1][hs]?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mi(?:queas|k(?:ieas|ey?as|a[hs]|a)?|c(?:a[hs]|a)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Nah(?:[u\\xFA]m)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Hab(?:a(?:kk?uk|cuc))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ze(?:p(?:h(?:ania[hs])?|anias)|f(?:anias)?)|S(?:(?:e[fp]ani|ofon[i\\xED])as|e[fp]ania)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Hag(?:g(?:eo|ai)|eo|ai)?|Ag(?:g?eo|ai)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Z(?:ech(?:ariah)?|ac(?:ar[i\\xED]as)?)|Sacar[i\\xED]as))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mal(?:a(?:qu[i\\xED]as|kias|chi))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:a(?:buting[\\s\\xa0]*Balita[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*)?Mateo|t(?:eo|t)?)|t)|Ebanghelyo[\\s\\xa0]*(?:ayon[\\s\\xa0]*kay[\\s\\xa0]*|ni[\\s\\xa0]*(?:San[\\s\\xa0]*)?)Mateo))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:a(?:buting[\\s\\xa0]*Balita[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*Mar[ck]|Mar[ck])os|r(?:kos|cos|k)?)|c)|Ebanghelyo[\\s\\xa0]*(?:ayon[\\s\\xa0]*kay[\\s\\xa0]*Marc|ni[\\s\\xa0]*(?:San[\\s\\xa0]*Mar[ck]|Mar[ck]))os))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mabuting[\\s\\xa0]*Balita[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*Lu[ck]|Lu[ck])as|Ebanghelyo[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*Lu[ck]|Lu[ck])as|Ebanghelyo[\\s\\xa0]*ni[\\s\\xa0]*San[\\s\\xa0]*Lu[ck]as|Lu(?:[ck]as|ke|c)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Una(?:ng)?[\s\xa0]*Jua|[1I]\.[\s\xa0]*Jua|1(?:[\s\xa0]*Jua|Joh|[\s\xa0]*J)|I[\s\xa0]*Jua)n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:I(?:kalawang|I\.?)[\s\xa0]*Jua|2(?:\.[\s\xa0]*Jua|[\s\xa0]*Jua|Joh|[\s\xa0]*J))n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:I(?:katlong|II\.?)[\s\xa0]*Jua|3(?:\.[\s\xa0]*Jua|[\s\xa0]*Jua|Joh|[\s\xa0]*J))n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:(?:Mabuting[\\s\\xa0]*Balita[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*)?Jua|Ebanghelyo[\\s\\xa0]*ayon[\\s\\xa0]*kay[\\s\\xa0]*(?:San[\\s\\xa0]*)?Jua|Ebanghelyo[\\s\\xa0]*ni[\\s\\xa0]*San[\\s\\xa0]*Jua|J(?:oh|ua)?)n))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:abuting[\\s\\xa0]*Balita[\\s\\xa0]*(?:ayon[\\s\\xa0]*sa|ng)[\\s\\xa0]*Espiritu[\\s\\xa0]*Santo|ga[\\s\\xa0]*Gawa(?:[\\s\\xa0]*ng[\\s\\xa0]*mga[\\s\\xa0]*A(?:postoles|lagad)|[\\s\\xa0]*ng[\\s\\xa0]*mga[\\s\\xa0]*Apostol|in)?)|Ebanghelyo[\\s\\xa0]*ng[\\s\\xa0]*Espiritu[\\s\\xa0]*Santo|G(?:awa[\\s\\xa0]*ng[\\s\\xa0]*mga[\\s\\xa0]*Apostol|w)|(?:Gawa[\\s\\xa0]*ng[\\s\\xa0]*Apostole|Act)s|Gawa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sulat[\\s\\xa0]*sa[\\s\\xa0]*mga[\\s\\xa0]*Romano|(?:Mga[\\s\\xa0]*Taga(?:\\-?[\\s\\xa0]*?|[\\s\\xa0]*)|Taga\\-?[\\s\\xa0]*)?Roma|Rom?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:SECOND[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?o|I(?:ka(?:\-?[\s\xa0]*2[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?|lawang[\s\xa0]*(?:Mga[\s\xa0]*Taga\-?[\s\xa0]*Corint|[CK]orinti?)|[\s\xa0]*2[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?)|I(?:(?:\.[\s\xa0]*Mga[\s\xa0]*Taga\-?|[\s\xa0]*Mga[\s\xa0]*Taga\-?)[\s\xa0]*Corint|(?:\.[\s\xa0]*[CK]|[\s\xa0]*[CK])orinti?))o|2(?:(?:\.[\s\xa0]*Mga[\s\xa0]*Taga\-?|[\s\xa0]*Mga[\s\xa0]*Taga\-?)[\s\xa0]*Corinto|(?:\.[\s\xa0]*[CK]|[\s\xa0]*K)orinti?o|[\s\xa0]*Corinti?o|[\s\xa0]*?Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:ka(?:\-?[\s\xa0]*1[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?|[\s\xa0]*1[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?)|\.?[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?|(?:\.[\s\xa0]*Mga[\s\xa0]*Taga\-?|[\s\xa0]*Mga[\s\xa0]*Taga\-?)[\s\xa0]*Corint|(?:\.[\s\xa0]*[CK]|[\s\xa0]*[CK])orinti?)o|(?:Unang|Una|1\.)[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?o|(?:(?:Unang|1\.)[\s\xa0]*Mga[\s\xa0]*Taga\-?|Una[\s\xa0]*Mga[\s\xa0]*Taga\-?|1[\s\xa0]*Mga[\s\xa0]*Taga\-?)[\s\xa0]*Corinto|(?:(?:Unang|1\.)[\s\xa0]*[CK]|Una[\s\xa0]*[CK]|1[\s\xa0]*K)orinti?o|1[\s\xa0]*Corinti?o|1[\s\xa0]*?Cor)|(?:1[\s\xa0]*Sulat[\s\xa0]*sa[\s\xa0]*mga[\s\xa0]*Corinti?o))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sulat[\\s\\xa0]*sa[\\s\\xa0]*mga[\\s\\xa0]*(?:taga[\\s\\xa0]*)?Galacia|Mga[\\s\\xa0]*Taga\\-?[\\s\\xa0]*Galasya|(?:Mga[\\s\\xa0]*Taga\\-?[\\s\\xa0]*)?Galacia|Mga[\\s\\xa0]*Taga\\-?Galacia|Taga\\-?[\\s\\xa0]*Galacia|Taga[\\s\\xa0]*Galacia|Ga(?:lasyano|l)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sulat[\\s\\xa0]*sa[\\s\\xa0]*mga[\\s\\xa0]*E[fp]esi?o|Mga[\\s\\xa0]*Taga\\-?[\\s\\xa0]*E[fp]esi?o|Mga[\\s\\xa0]*Taga\\-?Efeso|E(?:ph|f))|(?:(?:Taga(?:\\-?[\\s\\xa0]*E[fp]esi?|[\\s\\xa0]*E[fp]esi?)|Mga[\\s\\xa0]*E[fp]esi?|E[fp]esi?)o))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sulat[\\s\\xa0]*sa[\\s\\xa0]*mga[\\s\\xa0]*(?:Pilip(?:yano|ense)|Filipense)|Mga[\\s\\xa0]*Taga(?:\\-?(?:[\\s\\xa0]*[FP]|F)|[\\s\\xa0]*[FP])ilipos|Taga\\-?[\\s\\xa0]*[FP]ilipos|Mga[\\s\\xa0]*Pilipyano|Mga[\\s\\xa0]*Pilipense|Mga[\\s\\xa0]*Filipense|Filipos|Pilipos|Phil|Fil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sulat[\\s\\xa0]*sa[\\s\\xa0]*mga[\\s\\xa0]*[CK]olon?sense|(?:Mga[\\s\\xa0]*Taga(?:\\-?(?:[\\s\\xa0]*[CK]|C)|[\\s\\xa0]*[CK])|Taga\\-?[\\s\\xa0]*C|C|K)olosas|Mga[\\s\\xa0]*[CK]olon?sense|Col?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))|I(?:\.[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))|[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))))|2(?:\.[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))|[\s\xa0]*Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|[\s\xa0]*Tesalonicense|[\s\xa0]*Tesalonisense|[\s\xa0]*Tesalonica|[\s\xa0]*Tesalonika|(?:Thes|[\s\xa0]*The)s|[\s\xa0]*Tes)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))|[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka)))|[1I]\.[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))|1(?:[\s\xa0]*Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|[\s\xa0]*Tesalonicense|[\s\xa0]*Tesalonisense|[\s\xa0]*Tesalonica|[\s\xa0]*Tesalonika|(?:Thes|[\s\xa0]*The)s|[\s\xa0]*Tes)|I[\s\xa0]*(?:Mga[\s\xa0]*T(?:aga(?:\-?[\s\xa0]*Tesaloni[ck]|[\s\xa0]*Tesaloni[ck])a|esaloni[cs]ense)|Tesaloni(?:c(?:ense|a)|sense|ka))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang[\s\xa0]*(?:Kay[\s\xa0]*)?|I(?:\.[\s\xa0]*(?:Kay[\s\xa0]*)?|[\s\xa0]*(?:Kay[\s\xa0]*)?))Timoteo|2(?:\.[\s\xa0]*(?:Kay[\s\xa0]*)?Timoteo|[\s\xa0]*Kay[\s\xa0]*Timoteo|[\s\xa0]*Timoteo|[\s\xa0]*?Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng[\s\xa0]*(?:Kay[\s\xa0]*)?|[\s\xa0]*(?:Kay[\s\xa0]*)?)Timoteo|[1I]\.[\s\xa0]*(?:Kay[\s\xa0]*)?Timoteo|1(?:[\s\xa0]*Kay[\s\xa0]*Timoteo|[\s\xa0]*Timoteo|[\s\xa0]*?Tim)|I[\s\xa0]*(?:Kay[\s\xa0]*)?Timoteo))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Kay[\\s\\xa0]*Tito|Tit(?:us|o)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Kay[\\s\\xa0]*Filemon|Filemon|(?:File|(?:Ph|F)l)m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mga[\\s\\xa0]*(?:He|E)breo|Heb(?:reo)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:San(?:t(?:iago)?)?|Ja(?:cobo|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang|I\.?)[\s\xa0]*Pedro|2(?:\.[\s\xa0]*Pedro|[\s\xa0]*Pedro|[\s\xa0]*Ped|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng)?[\s\xa0]*Pedro|[1I]\.[\s\xa0]*Pedro|1(?:[\s\xa0]*Pedro|[\s\xa0]*Ped|Pet)|I[\s\xa0]*Pedro))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ju(?:das|de|d)?|Hudas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:T(?:ob(?:\\xEDas|i(?:as|t))?|b)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jdt"],
      ...
      },
      {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Bar(?:u[ck]h?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:S(?:i[\\s\\xa0]*Susana|u(?:sana|s)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kalawang[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|I(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)))|2(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*Mga[\s\xa0]*Macabeo|[\s\xa0]*Macabeos|[\s\xa0]*Macabeo|Macc|[\s\xa0]*Mcb)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:katlong[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|II(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)))|3(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*Mga[\s\xa0]*Macabeo|[\s\xa0]*Macabeos|[\s\xa0]*Macabeo|Macc|[\s\xa0]*Mcb)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:kaapat[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|V(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)))|4(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*Mga[\s\xa0]*Macabeo|[\s\xa0]*Macabeos|[\s\xa0]*Macabeo|Macc|[\s\xa0]*Mcb)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Una(?:ng[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|[1I]\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|1(?:[\s\xa0]*Mga[\s\xa0]*Macabeo|[\s\xa0]*Macabeos|[\s\xa0]*Macabeo|Macc|[\s\xa0]*Mcb)|I[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezek",
      "Ezra"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c60 = "pangkat",
        peg$c61 = peg$literalExpectation("pangkat", false),
        peg$c62 = "pang",
        peg$c63 = peg$literalExpectation("pang", false),
        peg$c64 = "kapitulo",
        peg$c65 = peg$literalExpectation("kapitulo", false),
        peg$c66 = "kap",
        peg$c67 = peg$literalExpectation("kap", false),
        peg$c68 = function() { return {"type": "c_explicit"} },
        peg$c69 = "tal",
        peg$c70 = peg$literalExpectation("tal", false),
        peg$c71 = "atang",
        peg$c72 = peg$literalExpectation("atang", false),
        ...
        peg$c80 = "at",
        peg$c81 = peg$literalExpectation("at", false),
        peg$c82 = function() { return "" },
        peg$c83 = /^[\-\u2013\u2014]/,
        peg$c84 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c85 = "titik",
        peg$c86 = peg$literalExpectation("titik", false),
        peg$c87 = "pamagat",
        peg$c88 = peg$literalExpectation("pamagat", false),
        ...
        peg$c94 = "in",
        peg$c95 = peg$literalExpectation("in", false),
        peg$c96 = "the",
        peg$c97 = peg$literalExpectation("the", false),
        peg$c98 = "book",
        peg$c99 = peg$literalExpectation("book", false),
        peg$c100 = /^[([]/,
