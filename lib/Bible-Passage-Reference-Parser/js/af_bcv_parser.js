(function() {
  ...
  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|en|tot)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Tess(?:alonisense)?|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Tess(?:alonisense)?|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c60 = "hoofstuk",
        peg$c61 = peg$literalExpectation("hoofstuk", false),
        peg$c62 = function() { return {"type": "c_explicit"} },
        peg$c63 = "vers",
        peg$c64 = peg$literalExpectation("vers", false),
        peg$c65 = "bybelvers",
        peg$c66 = peg$literalExpectation("bybelvers", false),
        ...
        peg$c74 = "en",
        peg$c75 = peg$literalExpectation("en", false),
        peg$c76 = function() { return "" },
        peg$c77 = /^[\-\u2013\u2014]/,
        peg$c78 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c79 = "tot",
        peg$c80 = peg$literalExpectation("tot", false),
        peg$c81 = "title",
